...
Namespace cnx5
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute(ConfigurationName:="cnx5.ws_serviciosSoap")>  _
    Public Interface ws_serviciosSoap
        ...
        Function ReiniciarServicio(ByVal request As cnx5.ReiniciarServicioRequest) As cnx5.ReiniciarServicioResponse
        ...
        Function ReiniciarPC(ByVal request As cnx5.ReiniciarPCRequest) As cnx5.ReiniciarPCResponse
        ...
        Function obtenerLog(ByVal request As cnx5.obtenerLogRequest) As cnx5.obtenerLogResponse
    End Interface
    ...
    Partial Public Class ReiniciarServicioRequest
        ...
        Public Body As cnx5.ReiniciarServicioRequestBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx5.ReiniciarServicioRequestBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class ReiniciarServicioResponse
        ...
        Public Body As cnx5.ReiniciarServicioResponseBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx5.ReiniciarServicioResponseBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class ReiniciarPCRequest
        ...
        Public Body As cnx5.ReiniciarPCRequestBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx5.ReiniciarPCRequestBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class ReiniciarPCResponse
        ...
        Public Body As cnx5.ReiniciarPCResponseBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx5.ReiniciarPCResponseBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class obtenerLogRequest
        ...
        Public Body As cnx5.obtenerLogRequestBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx5.obtenerLogRequestBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class obtenerLogResponse
        ...
        Public Body As cnx5.obtenerLogResponseBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx5.obtenerLogResponseBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Public Interface ws_serviciosSoapChannel
        Inherits cnx5.ws_serviciosSoap, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")>  _
    Partial Public Class ws_serviciosSoapClient
        Inherits System.ServiceModel.ClientBase(Of cnx5.ws_serviciosSoap)
        Implements cnx5.ws_serviciosSoap
        ...
        Function cnx5_ws_serviciosSoap_ReiniciarServicio(ByVal request As cnx5.ReiniciarServicioRequest) As cnx5.ReiniciarServicioResponse Implements cnx5.ws_serviciosSoap.ReiniciarServicio
            Return MyBase.Channel.ReiniciarServicio(request)
        End Function
        
        Public Function ReiniciarServicio() As String
            Dim inValue As cnx5.ReiniciarServicioRequest = New cnx5.ReiniciarServicioRequest
            inValue.Body = New cnx5.ReiniciarServicioRequestBody
            Dim retVal As cnx5.ReiniciarServicioResponse = CType(Me,cnx5.ws_serviciosSoap).ReiniciarServicio(inValue)
            Return retVal.Body.ReiniciarServicioResult
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function cnx5_ws_serviciosSoap_ReiniciarPC(ByVal request As cnx5.ReiniciarPCRequest) As cnx5.ReiniciarPCResponse Implements cnx5.ws_serviciosSoap.ReiniciarPC
            Return MyBase.Channel.ReiniciarPC(request)
        End Function
        
        Public Function ReiniciarPC() As String
            Dim inValue As cnx5.ReiniciarPCRequest = New cnx5.ReiniciarPCRequest
            inValue.Body = New cnx5.ReiniciarPCRequestBody
            Dim retVal As cnx5.ReiniciarPCResponse = CType(Me,cnx5.ws_serviciosSoap).ReiniciarPC(inValue)
            Return retVal.Body.ReiniciarPCResult
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function cnx5_ws_serviciosSoap_obtenerLog(ByVal request As cnx5.obtenerLogRequest) As cnx5.obtenerLogResponse Implements cnx5.ws_serviciosSoap.obtenerLog
            Return MyBase.Channel.obtenerLog(request)
        End Function
        
        Public Function obtenerLog() As String
            Dim inValue As cnx5.obtenerLogRequest = New cnx5.obtenerLogRequest
            inValue.Body = New cnx5.obtenerLogRequestBody
            Dim retVal As cnx5.obtenerLogResponse = CType(Me,cnx5.ws_serviciosSoap).obtenerLog(inValue)
