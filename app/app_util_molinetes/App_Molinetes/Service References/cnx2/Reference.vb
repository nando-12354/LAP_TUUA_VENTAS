...
Namespace cnx2
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute(ConfigurationName:="cnx2.ws_serviciosSoap")>  _
    Public Interface ws_serviciosSoap
        ...
        Function ReiniciarServicio(ByVal request As cnx2.ReiniciarServicioRequest) As cnx2.ReiniciarServicioResponse
        ...
        Function ReiniciarPC(ByVal request As cnx2.ReiniciarPCRequest) As cnx2.ReiniciarPCResponse
        ...
        Function obtenerLog(ByVal request As cnx2.obtenerLogRequest) As cnx2.obtenerLogResponse
    End Interface
    ...
    Partial Public Class ReiniciarServicioRequest
        ...
        Public Body As cnx2.ReiniciarServicioRequestBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx2.ReiniciarServicioRequestBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class ReiniciarServicioResponse
        ...
        Public Body As cnx2.ReiniciarServicioResponseBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx2.ReiniciarServicioResponseBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class ReiniciarPCRequest
        ...
        Public Body As cnx2.ReiniciarPCRequestBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx2.ReiniciarPCRequestBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class ReiniciarPCResponse
        ...
        Public Body As cnx2.ReiniciarPCResponseBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx2.ReiniciarPCResponseBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class obtenerLogRequest
        ...
        Public Body As cnx2.obtenerLogRequestBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx2.obtenerLogRequestBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class obtenerLogResponse
        ...
        Public Body As cnx2.obtenerLogResponseBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx2.obtenerLogResponseBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Public Interface ws_serviciosSoapChannel
        Inherits cnx2.ws_serviciosSoap, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")>  _
    Partial Public Class ws_serviciosSoapClient
        Inherits System.ServiceModel.ClientBase(Of cnx2.ws_serviciosSoap)
        Implements cnx2.ws_serviciosSoap
        ...
        Function cnx2_ws_serviciosSoap_ReiniciarServicio(ByVal request As cnx2.ReiniciarServicioRequest) As cnx2.ReiniciarServicioResponse Implements cnx2.ws_serviciosSoap.ReiniciarServicio
            Return MyBase.Channel.ReiniciarServicio(request)
        End Function
        
        Public Function ReiniciarServicio() As String
            Dim inValue As cnx2.ReiniciarServicioRequest = New cnx2.ReiniciarServicioRequest
            inValue.Body = New cnx2.ReiniciarServicioRequestBody
            Dim retVal As cnx2.ReiniciarServicioResponse = CType(Me,cnx2.ws_serviciosSoap).ReiniciarServicio(inValue)
            Return retVal.Body.ReiniciarServicioResult
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function cnx2_ws_serviciosSoap_ReiniciarPC(ByVal request As cnx2.ReiniciarPCRequest) As cnx2.ReiniciarPCResponse Implements cnx2.ws_serviciosSoap.ReiniciarPC
            Return MyBase.Channel.ReiniciarPC(request)
        End Function
        
        Public Function ReiniciarPC() As String
            Dim inValue As cnx2.ReiniciarPCRequest = New cnx2.ReiniciarPCRequest
            inValue.Body = New cnx2.ReiniciarPCRequestBody
            Dim retVal As cnx2.ReiniciarPCResponse = CType(Me,cnx2.ws_serviciosSoap).ReiniciarPC(inValue)
            Return retVal.Body.ReiniciarPCResult
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function cnx2_ws_serviciosSoap_obtenerLog(ByVal request As cnx2.obtenerLogRequest) As cnx2.obtenerLogResponse Implements cnx2.ws_serviciosSoap.obtenerLog
            Return MyBase.Channel.obtenerLog(request)
        End Function
        
        Public Function obtenerLog() As String
            Dim inValue As cnx2.obtenerLogRequest = New cnx2.obtenerLogRequest
            inValue.Body = New cnx2.obtenerLogRequestBody
            Dim retVal As cnx2.obtenerLogResponse = CType(Me,cnx2.ws_serviciosSoap).obtenerLog(inValue)
