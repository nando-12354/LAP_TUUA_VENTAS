...
Namespace cnx6
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute(ConfigurationName:="cnx6.ws_serviciosSoap")>  _
    Public Interface ws_serviciosSoap
        ...
        Function ReiniciarServicio(ByVal request As cnx6.ReiniciarServicioRequest) As cnx6.ReiniciarServicioResponse
        ...
        Function ReiniciarPC(ByVal request As cnx6.ReiniciarPCRequest) As cnx6.ReiniciarPCResponse
        ...
        Function obtenerLog(ByVal request As cnx6.obtenerLogRequest) As cnx6.obtenerLogResponse
    End Interface
    ...
    Partial Public Class ReiniciarServicioRequest
        ...
        Public Body As cnx6.ReiniciarServicioRequestBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx6.ReiniciarServicioRequestBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class ReiniciarServicioResponse
        ...
        Public Body As cnx6.ReiniciarServicioResponseBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx6.ReiniciarServicioResponseBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class ReiniciarPCRequest
        ...
        Public Body As cnx6.ReiniciarPCRequestBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx6.ReiniciarPCRequestBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class ReiniciarPCResponse
        ...
        Public Body As cnx6.ReiniciarPCResponseBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx6.ReiniciarPCResponseBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class obtenerLogRequest
        ...
        Public Body As cnx6.obtenerLogRequestBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx6.obtenerLogRequestBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class obtenerLogResponse
        ...
        Public Body As cnx6.obtenerLogResponseBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As cnx6.obtenerLogResponseBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Public Interface ws_serviciosSoapChannel
        Inherits cnx6.ws_serviciosSoap, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")>  _
    Partial Public Class ws_serviciosSoapClient
        Inherits System.ServiceModel.ClientBase(Of cnx6.ws_serviciosSoap)
        Implements cnx6.ws_serviciosSoap
        ...
        Function cnx6_ws_serviciosSoap_ReiniciarServicio(ByVal request As cnx6.ReiniciarServicioRequest) As cnx6.ReiniciarServicioResponse Implements cnx6.ws_serviciosSoap.ReiniciarServicio
            Return MyBase.Channel.ReiniciarServicio(request)
        End Function
        
        Public Function ReiniciarServicio() As String
            Dim inValue As cnx6.ReiniciarServicioRequest = New cnx6.ReiniciarServicioRequest
            inValue.Body = New cnx6.ReiniciarServicioRequestBody
            Dim retVal As cnx6.ReiniciarServicioResponse = CType(Me,cnx6.ws_serviciosSoap).ReiniciarServicio(inValue)
            Return retVal.Body.ReiniciarServicioResult
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function cnx6_ws_serviciosSoap_ReiniciarPC(ByVal request As cnx6.ReiniciarPCRequest) As cnx6.ReiniciarPCResponse Implements cnx6.ws_serviciosSoap.ReiniciarPC
            Return MyBase.Channel.ReiniciarPC(request)
        End Function
        
        Public Function ReiniciarPC() As String
            Dim inValue As cnx6.ReiniciarPCRequest = New cnx6.ReiniciarPCRequest
            inValue.Body = New cnx6.ReiniciarPCRequestBody
            Dim retVal As cnx6.ReiniciarPCResponse = CType(Me,cnx6.ws_serviciosSoap).ReiniciarPC(inValue)
            Return retVal.Body.ReiniciarPCResult
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function cnx6_ws_serviciosSoap_obtenerLog(ByVal request As cnx6.obtenerLogRequest) As cnx6.obtenerLogResponse Implements cnx6.ws_serviciosSoap.obtenerLog
            Return MyBase.Channel.obtenerLog(request)
        End Function
        
        Public Function obtenerLog() As String
            Dim inValue As cnx6.obtenerLogRequest = New cnx6.obtenerLogRequest
            inValue.Body = New cnx6.obtenerLogRequestBody
            Dim retVal As cnx6.obtenerLogResponse = CType(Me,cnx6.ws_serviciosSoap).obtenerLog(inValue)
