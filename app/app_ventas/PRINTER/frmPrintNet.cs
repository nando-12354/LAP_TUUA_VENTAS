            ...
            if (this.getFlagSticker().Equals("1"))
            {
                ...
                if (this.getFlagVoucher().Equals("1"))
                {
                        ...
                        retornoSticker != Variables.FLAG_PRINTER_STATUS_STICKER_OPERATIVE)
                    {
                        ...
                        SetSetEnabledBtnImprimir(true); /// WC
                        enabledPrintSticker = true;  // WC
...
*/
        ...
        //private void btnImprimir_Click(object sender, EventArgs e) //FL.
        //{
        //    PrintDocument pd = new PrintDocument();

        //    pd.PrinterSettings.PrinterName = "EPSON L395 Series";
        ...
        //    else
        //    {
        //        MessageBox.Show("No se encuentra la impresora EPSON L395.");
        //    }
        //}
        ...
        //--------------------- METODOS DE COMBOBOX USB ---------------------\\
        //private void chkPuertoUsbVoucher_CheckedChanged(object sender, EventArgs e)
        //{
        //    if (chkPuertoUsbVoucher.Checked)
        //    {
        //        cboPtosUsbVoucher.Enabled = true;
        //    }
        //    else
        //    {
        //        cboPtosUsbVoucher.Enabled = false;
        //    }
        //}

        //private void chkPuertoUsbSticker_CheckedChanged(object sender, EventArgs e)
        //{
        //    if (chkPuertoUsbSticker.Checked)
        //    {
        //        cboPtosUsbSticker.Enabled = true;
        //    }
        //    else
        //    {
        //        cboPtosUsbSticker.Enabled = false;
        //    }
        //}
        //-------------------------------------------------------------------\\
        #endregion
