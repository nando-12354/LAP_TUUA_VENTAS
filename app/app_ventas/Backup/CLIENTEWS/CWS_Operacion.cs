...
namespace LAP.TUUA.CLIENTEWS
{
    public class CWS_Operacion : CWS_Conexion
    {
        ...
        {
            wsOperacion.WSOperacion service = new wsOperacion.WSOperacion();
            return service.GenerarTicket(strCompania, strVentaMasiva, strNumVuelo, strFecVuelo, strTurno, strUsuario, decPrecio, strMoneda, strModVenta, strTipTicket, strTipVuelo, intTickets, strFlagCont, strNumRef, strTipPago, strEmpresa, strRepte, ref  strFecVence, ref strListaTickets);
        }
