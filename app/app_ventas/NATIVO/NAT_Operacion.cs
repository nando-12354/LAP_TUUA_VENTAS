    ...
    public class NAT_Operacion : NAT_Conexion
    {
        ...
        public override bool RegistrarTicket(string strCompania, string strVentaMasiva, string strNumVuelo, string strFecVuelo, string strTurno, string strUsuario, decimal decPrecio, string strMoneda, string strModVenta, string strTipTicket, string strTipVuelo, int intTickets, string strFlagCont, string strNumRef, string strTipPago, string strEmpresa, string strRepte, ref string strFecVence, ref string strListaTickets, string strCodTurnoIng, string strFlgCierreTurno, string strCodPrecio, string strMetPago, string strEmpresaRecaudadora) //FL.
        {
            try
            {
                ...
                objDAOTicket.Cod_Sub_Modulo = Cod_Sub_Modulo;
                objDAOTicket.Cod_Usuario = Cod_Usuario;
                return objDAOTicket.insertar( strCompania,  strVentaMasiva,  strNumVuelo,  strFecVuelo,  strTurno,  strUsuario,  decPrecio,  strMoneda,  strModVenta,  strTipTicket,  strTipVuelo,  intTickets, strFlagCont, strNumRef, strTipPago,strEmpresa,strRepte,ref  strFecVence,ref strListaTickets,null,null,null,strMetPago,strEmpresaRecaudadora); //FL.
            }
            catch (Exception ex)
            {
                ErrorHandler.ObtenerCodigoExcepcion(ex.GetType().Name);
        ...
        public override bool ExtornarTicket(string strListaTickets, string strTurno, int intCantidad , string strMotivo, string strUsuario, ref string strMessage)
        {
            try
            {
                ...
                objDAOTicket.Cod_Sub_Modulo = Cod_Sub_Modulo;
                objDAOTicket.Cod_Usuario = Cod_Usuario;
                return objDAOTicket.ExtornarTicket(strListaTickets, strTurno, intCantidad, strMotivo, strUsuario, ref strMessage);
            }
            catch (Exception ex)
            {
                ErrorHandler.ObtenerCodigoExcepcion(ex.GetType().Name);
