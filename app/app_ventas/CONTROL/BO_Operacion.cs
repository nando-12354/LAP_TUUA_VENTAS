...
namespace LAP.TUUA.CONTROL
{
    public class BO_Operacion
    {
        ...
        public bool RegistrarVentaNormal(Hashtable htFlujoCaja, decimal decImpDialogo, string strModVenta, int intCantidad, decimal decTasaCambio, TipoTicket objTipoTicket, string strCompania, string strVuelo, string strFecVuelo, string strTurno, string strUsuario, decimal decMonto, string strMoneda, string strNumRef, string strTipPago, decimal decMontoSol, List<Cambio> listaCambio, ref string strFecVence, ref string strListaTickets, ref decimal decTCPagado, string strMetPago, string strEmpresaRecaudadora) //FL.
        {
            ...
            if (!ValidarVentaTicket(strTipPago, listaTurnoMonto, strMonNac, strMoneda, decMonto, decTasaCambio, intCantidad, objTipoTicket, decMontoSol, decImpDialogo, ref decTCPagado, strMetPago)) //FL.
            {
                return false;
            }
            ...
            if (strTipPago != Define.TIP_PAGO_EFECTIVO && strMetPago == Define.MET_PAGO_AL_CONTADO) //FL.
            {
                strMetPago = null;
            }
            return RegistrarTicket(strModVenta, intCantidad, decTasaCambio, objTipoTicket, strCompania, strVuelo, strFecVuelo, strTurno, strUsuario, decMonto, strMoneda, decIngreso, decEgresoNac, listaTurnoMonto, strNumRef, strTipPago, null, null, decIngresoNac, ref strFecVence, ref strListaTickets, strMetPago, strEmpresaRecaudadora); //FL.
        }

        public bool RegistrarTicket(string strModVenta, int intCantidad, decimal decTasaCambio, TipoTicket objTipoTicket, string strCompania, string strVuelo, string strFecVuelo, string strTurno, string strUsuario, decimal decMonto, string strMoneda, decimal decIngreso, decimal decEgresoNac, List<TurnoMonto> listaTurnoMonto, string strNumRef, string strTipPago, string strEmpresa, string strRepte, decimal decIngresoNac, ref string strFecVence, ref string strListaTickets, string strMetPago, string strEmpresaRecaudadora) //FL.
        {
            string strMonNac = Property.htProperty[Define.MONEDANAC].ToString();
            // se guarda la lista de tickets (GGarcia-20090909)
            //objTipoTicket.ListaTicketImp = listaTickets;

            if (!objCnxOpera.RegistrarTicket(strCompania, null, strVuelo, strFecVuelo, strTurno, strUsuario, objTipoTicket.DImpPrecio, objTipoTicket.SCodMoneda, strModVenta, objTipoTicket.SCodTipoTicket, objTipoTicket.STipVuelo, intCantidad, "0", strNumRef, strTipPago, strEmpresa, strRepte, ref strFecVence, ref strListaTickets, null, null, "", strMetPago, strEmpresaRecaudadora))
            {
                dsc_Message = "Transacción no completada.";
                return false;
            }
        ...
        public bool RegistrarVentaMasiva(Hashtable htFlujoCaja, decimal decImpDialogo, string strCodModVenta, VentaMasiva objVentaMasiva, string strTurno, TipoTicket objTipoTicket, decimal decMonto, string strNumero, decimal decTasaCambio, string strNumVuelo, string strFecVuelo, string strTipPago, string strEmpresa, string strRepte, decimal decMontoSol, List<Cambio> listaCambio, ref string strFecVence, ref string strListaTickets, ref decimal decTCPagado, string strMetPago, string strEmpresaRecaudadora) //FL.
        {
            ...
            if (!ValidarVentaTicket(strTipPago, listaTurnoMonto, strMonNac, strMoneda, decMonto, decTasaCambio, objVentaMasiva.DCanVenta, objTipoTicket, decMontoSol, decImpDialogo, ref decTCPagado, strMetPago)) //FL.
            {
                return false;
            }
            if (!VerificarMargenCajaTicket(listaTurnoMonto, htFlujoCaja))
            ...
            if (strTipPago != Define.TIP_PAGO_EFECTIVO && strMetPago == Define.MET_PAGO_AL_CREDITO) //FL.
            {
                strMetPago = null;
            }
        ...
        private bool ValidarVentaTicket(string strTipPago, List<TurnoMonto> listaTurnoMonto, string strMonNac, string strMoneda, decimal decMonto, decimal decTasaCambio, int intCantidad, TipoTicket objTipoTicket, decimal decMontoSol, decimal decMontoDialogo, ref decimal decTCPagado, string strMetPago) //FL.
        {
        ...
        {
            return objCnxOpera.ExtornarTicket(strListaTickets, strTurno, intCantidad, strMotivo, strUsuario, ref strMessage);
        }
