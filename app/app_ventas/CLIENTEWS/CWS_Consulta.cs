...
namespace LAP.TUUA.CLIENTEWS
{
    public class CWS_Consulta : CWS_Conexion
    {
        ...
        public override System.Data.DataTable ConsultaTurnoxFiltro(string sFchIni, string sFchFin, string sCodUsuario, string sPtoVta, string sHoraDesde, string sHoraHasta, string flagReporte = "0")
        {
        ...
        public override System.Data.DataTable ObtenerEmpresaPorIdentificadorPadre(string identificador)
        {
            throw new Exception("The method or operation is not implemented.");
        }
