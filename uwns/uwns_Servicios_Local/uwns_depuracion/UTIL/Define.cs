...
namespace LAP.TUUA.UTIL
{
    public class Define
    {
        ...
        public const string TIMEOUT_CL = "TIMEOUT_CL";
        public const string TIMEOUT_LC = "TIMEOUT_LC";
        ...
        public const string LOCAL_CENTER_SERVICE = "2";
        public const string INTERVALO_TRANSACCION = "INTERVALO_TRANSACCION";
        public const string MODO_SINCRONISMO = "MODO_SINCRONISMO";
        public const string IP_SERVIDOR = "IP_SERVIDOR";
