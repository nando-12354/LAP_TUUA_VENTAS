    ...
    void ITemplate.InstantiateIn(System.Web.UI.Control container)
    {
        switch (_templateType)
        {
            ...
            case ListItemType.Item:
                ...
                lblbox.DataBinding += new EventHandler(tb1_DataBinding);   //Attaches the data binding event.
                //lblbox.Columns = 4;                                        //Creates a column with size 4.
                container.Controls.Add(lblbox);                            //Adds the newly created textbox to the container.
                break;
