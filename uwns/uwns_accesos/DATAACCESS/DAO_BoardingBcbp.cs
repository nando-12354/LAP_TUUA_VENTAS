    ...
    public class DAO_BoardingBcbp : DAO_BaseDatos   
    {
        ...
        public bool insertar(BoardingBcbp objBoardingBcbp)
        {
            try
            {
                ...
                helper.AddInParameter(objCommandWrapper, "Num_Airline_Code", DbType.String, objBoardingBcbp.Num_Airline_Code);
                helper.AddInParameter(objCommandWrapper, "Num_Document_Form", DbType.String, objBoardingBcbp.Num_Document_Form);
                helper.AddInParameter(objCommandWrapper, "Num_Checkin", DbType.String, objBoardingBcbp.Num_Checkin);
                isRegistrado = base.mantenerSP2(objCommandWrapper);
                return isRegistrado;
            }
            catch (Exception)
            {
        ...
        /// <summary>
        /// Saves a record to the DAOBoardingBcbp table en modo OffLine.
        /// </summary>

        public bool insertarOffLine(BoardingBcbp objBoardingBcbp)
        {
            try
            {
                Hashtable hsInsertUSP = (Hashtable)htSPConfig["BOARDINGSP_INSERT_OFFLINE"];

                string sNombreSP = (string)hsInsertUSP["BOARDINGSP_INSERT_OFFLINE"];
       ...
       public BoardingBcbp obtener(string strCod_Compania, string strNum_Vuelo, string strFechVuelo,string strNumeroAsiento,
                                      string strNomPasajero, string strtipEstado, string strCodUnicoBcbp, string strNumSecuencialBcbp, string strNumCheckin)
        {
            ...
            result = base.listarDataReaderSP(strNombreSP, strCod_Compania, strNum_Vuelo,strFechVuelo,strNumeroAsiento,strNomPasajero,
                                             strtipEstado, strCodUnicoBcbp, strNumSecuencialBcbp, strNumCheckin);
        ...
        public BoardingBcbp poblar(IDataReader dataReader)
        {
            ...
            //CMONTES-22-08-2015
            if (dataReader["Num_Checkin"] != DBNull.Value)
                objBoardingBcbp.Num_Checkin = (string)dataReader["Num_Checkin"];
