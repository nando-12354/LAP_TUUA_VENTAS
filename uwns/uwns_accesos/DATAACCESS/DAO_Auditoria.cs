...
namespace LAP.TUUA.DAO
{
    public class DAO_Auditoria : DAO_BaseDatos
    {
        ...
        public bool InsertarAuditoriaModificarTipoMolinete(string Cod_Molinete, string Tipo_Molinete, string Usuario)
        {
            try
            {
                Hashtable hsInsertUSP = (Hashtable)htSPConfig["AUDITIPOMOLI_INSERT"];
                string sNombreSP = (string)hsInsertUSP["AUDITIPOMOLI_INSERT"];

                DbCommand objCommandWrapper = helper.GetStoredProcCommand(sNombreSP);
                helper.AddInParameter(objCommandWrapper, (string)hsInsertUSP["Cod_Molinete"], DbType.String, Cod_Molinete);
                helper.AddInParameter(objCommandWrapper, (string)hsInsertUSP["Tip_Molinete"], DbType.String, Tipo_Molinete);
                helper.AddInParameter(objCommandWrapper, (string)hsInsertUSP["Cod_Usuario"], DbType.String, Usuario);
                isRegistrado = base.mantenerSPSinAuditoria(objCommandWrapper);
                return isRegistrado;
            }
            catch (Exception)
        ...
        public bool InsertarAuditoriaDestrabeMolinete(string Cod_Molinete, string Usuario, string TipoResultado)
        {
            try
            {
                Hashtable hsInsertUSP = (Hashtable)htSPConfig["AUDITDESTRAB_INSERT"];
                string sNombreSP = (string)hsInsertUSP["AUDITDESTRAB_INSERT"];

                DbCommand objCommandWrapper = helper.GetStoredProcCommand(sNombreSP);
                helper.AddInParameter(objCommandWrapper, (string)hsInsertUSP["Cod_Molinete"], DbType.String, Cod_Molinete);
                helper.AddInParameter(objCommandWrapper, (string)hsInsertUSP["Cod_Usuario"], DbType.String, Usuario);
                helper.AddInParameter(objCommandWrapper, (string)hsInsertUSP["Tip_Resultado"], DbType.String, TipoResultado);
                isRegistrado = base.mantenerSPSinAuditoria(objCommandWrapper);
                return isRegistrado;
            }
            catch (Exception)
