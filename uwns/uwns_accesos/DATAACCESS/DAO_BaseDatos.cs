    ...
    public class DAO_BaseDatos
    {
        ...
        public DAO_BaseDatos(string sConfigSPPath)
        {
            try
            {
                ...
                iTimeOut = Convert.ToInt32((string)Property.htProperty["TIMEOUT_LECTURA"]); //eochoa - 17-05-2011 - Tiempo máximo de espera
                Conexion();
            }
            catch (Exception)
            {
        ...
        protected bool mantenerSP(DbCommand objComando)
        {
              try
              {
                  //eochoa - 17-05-2011 - Tiempo máximo de espera
                  objComando.CommandTimeout = iTimeOut;
        ...
        protected bool mantenerSP2(DbCommand objComando)
        {
            try
            {
                //eochoa - 17-05-2011 - Tiempo máximo de espera
                ...
                helper.AddParameter(objComando, "@Result", DbType.Object, ParameterDirection.ReturnValue, "@Result", DataRowVersion.Default, objResult);
                helper.ExecuteNonQuery(objComando);

                int res = (int)helper.GetParameterValue(objComando, "@Result");
        ...
        protected IDataReader listarDataReaderSP(string strNombreSP, params object[] args)
        {
            ...
            {
                ErrorHandler.EscribirLog(this,ex.Message);
                throw;
            }
        }
