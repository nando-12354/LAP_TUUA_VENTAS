...
namespace LAP.TUUA.ENTIDADES
{
    public class Molinete
    {
        ...
        /// Initializes a new instance of the Compania class.
        /// </summary>
        public Molinete(string sCodMolinete, string sDscIp, string sDscMolinete, string sTipDocumento, string sTipVuelo, string sTipAcceso, string sTipEstado, string sLogUsuarioMod, string dtLogFechaMod, string sLogHoraMod, string sEstMaster, string sDscDBName,string sDscDBUser,string sDscDBPassword,int iCantidad)
        {
