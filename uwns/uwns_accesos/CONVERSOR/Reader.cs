...
namespace LAP.TUUA.CONVERSOR
{
    public class Reader
    {
        ...
        /* public Hashtable Parse_Boarding_Multiple_ACS(String strTrama)
         {
             ...
             try
             {
                 ...
                 int i = 0;
                 Hashtable htFlightInformation=null;
                 ...
                 while (i < Int32.Parse((string)htBoarding["number_segments_encoded"]))
                 {
                     ...
                     foreach (XmlNode xmlCampo in lstCampo2)
                     {
                         ...
                         if (nombreKey.Equals("field_size_following_variable_size_field"))
                         {
                             ...
                             htFlightInformation["field_size_following_variable_size_field"] = intSizeIndividualUse.ToString();
                             //if (intSizeIndividualUse > 0 && strTrama.Length>=intSizeIndividualUse)
                             //{
                             //      string strIndividualValue = strTrama.Substring(0, intSizeIndividualUse);
                             //      htFlightInformation.Add("individual_airline", strIndividualValue);
                     ...
                     break; //Linea agregada por problemas en multisegmento (solo se procesa el primer segmento)
                 }
                 htBoarding.Add("flight_information", ArrLst);
                 if (htFlightInformation["field_size_following_variable_size_field"].ToString().Trim() != "0")
                 {
                     foreach (XmlNode xmlCampo in lstCampo3)
                     {
                         if (strTrama != "")
                         {
                             ...
                             //Modificacion solo para aerolinea DELTA
                             if ((htFlightInformation["airline_designator"].ToString().Trim() == "DL" || htFlightInformation["airline_designator"].ToString().Trim() == "KL") && nombreKey == "airline_designetor_boarding_pass_issuer")
                                 break;

                             //Modificacion solo para aerolinea TACA - kinzi -   13.06.2011
                             if (htFlightInformation["airline_designator"].ToString().Trim() == "TA" && nombreKey == "begining_version_number" && intSizeIndividualUse == 1)
                                 break;

                             //Modificacion solo para aerolinea AIR FRANCE - kinzi -   18.07.2011
                             if (htFlightInformation["airline_designator"].ToString().Trim() == "AF" && nombreKey == "begining_version_number" && intSizeIndividualUse == 11)
                                 break;

                             //Modificacion solo para aerolinea KLM - kinzi -   19.07.2011
                             if (htFlightInformation["airline_designator"].ToString().Trim() == "KL" && nombreKey == "date_issue_boarding_pass" && intSizeIndividualUse == 11)
                                 break;

                             //Modificacion solo para aerolinea STAR UP - Charter - kinzi - 30.06.2011
                             if (htFlightInformation["airline_designator"].ToString().Trim() == "2I" && nombreKey == "airline_designetor_boarding_pass_issuer")
                                 break;
        ...
        //                string strTramaCondit = strTrama.Substring(0, intVariableSizeField);
        //                try
        //                {
        //                    if (i == 0)
        //                    {
