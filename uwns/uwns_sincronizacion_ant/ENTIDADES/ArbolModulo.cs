...
namespace LAP.TUUA.ENTIDADES
{
    public class ArbolModulo
    {
        ...
        /// Initializes a new instance of the ArbolModulo class.
        /// </summary>
        public ArbolModulo(string sCodProceso, string sCodProcesoPadre, string sCodModulo, string sIdProceso, string sDscProceso, int iTipNivel, string sTipEstado, string sFlgPermitido, string sDscArchivo, string sDscIcono, string sDscTextoAyuda, string sDscIndCritic, string sDscColorCritic, string sDscTabFiltro, string sDscLicencia, int iNumPosProceso, string sDscModulo, string sNomRol, int iNumPosModulo)
        {
