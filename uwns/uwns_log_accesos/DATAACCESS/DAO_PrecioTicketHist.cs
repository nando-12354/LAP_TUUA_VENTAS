    ...
    public class DAO_PrecioTicketHist : DAO_BaseDatos
    {
        ...
        public DataTable obtener(string sCodPrecioTicket)
        {
            ...
            strSQL = "SELECT pth.Cod_Precio_Ticket, pth.Cod_Tipo_Ticket, pth.Cod_Moneda, pth.Imp_Precio," +
                        ...
                        "pth.Log_Fecha_Mod, pth.Log_Hora_Mod, tt.Dsc_Tipo_Ticket, tm.Dsc_Moneda, tm.Dsc_Simbolo,CONVERT(CHAR(10),pth.Fch_Ini,103) Fch_IniSH,CONVERT(CHAR(10),pth.Fch_Fin,103) Fch_FinSH, tu.Nom_Usuario+', '+tu.Ape_Usuario Nom_Usuario_Mod" +
