    ...
    public class DAO_BoardingBcbpErr : DAO_BaseDatos
    {
        ...
        public bool insertar(BoardingBcbpErr objBoardingBcbpErr)
        {
            try
            {
                ...
                helper.AddInParameter(objCommandWrapper, (string)hsInsertUSP["Cod_Equipo_Mod"], DbType.String, objBoardingBcbpErr.StrCodEquipoMod);
                helper.AddInParameter(objCommandWrapper, (string)hsInsertUSP["Tip_Boarding"], DbType.String, objBoardingBcbpErr.StrTipBoarding);
                helper.AddInParameter(objCommandWrapper, (string)hsInsertUSP["Cod_Compania"], DbType.String, objBoardingBcbpErr.StrCodCompania);
                helper.AddInParameter(objCommandWrapper, (string)hsInsertUSP["Num_Vuelo"], DbType.String, objBoardingBcbpErr.StrNumVuelo);
                helper.AddInParameter(objCommandWrapper, (string)hsInsertUSP["Fch_Vuelo"], DbType.String, objBoardingBcbpErr.StrFchVuelo);
                helper.AddInParameter(objCommandWrapper, (string)hsInsertUSP["Num_Asiento"], DbType.String, objBoardingBcbpErr.StrNumAsiento);
                helper.AddInParameter(objCommandWrapper, (string)hsInsertUSP["Nom_Pasajero"], DbType.String, objBoardingBcbpErr.StrNomPasajero);
                helper.AddInParameter(objCommandWrapper, (string)hsInsertUSP["Log_Error"], DbType.String, objBoardingBcbpErr.StrLogError);
