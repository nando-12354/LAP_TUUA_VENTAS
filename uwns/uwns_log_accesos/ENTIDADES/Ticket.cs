...
namespace LAP.TUUA.ENTIDADES
{
	public class Ticket
	{
        ...
        private string dsc_Estado_Actual;
        private string flg_Sincroniza;
        ...
        public string Flg_Sincroniza
        {
            get
            {
                return flg_Sincroniza;
            }
            set
            {
                flg_Sincroniza = value;
            }
        }
        ...
        public string Dsc_Estado_Actual
        {
            get
            {
                return dsc_Estado_Actual;
            }
            set
            {
                dsc_Estado_Actual = value;
            }
        }
