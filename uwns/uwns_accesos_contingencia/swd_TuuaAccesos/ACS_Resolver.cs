    ...
    class ACS_Resolver
    {
        ...
        public bool InsertarAuditoriaDestrabeMolinete(string Cod_Molinete, string Usuario, string TipoResultado)
        {
            try
            {
                if (ACS_Property.BConRemota)
                {
                    Obj_DAOAuditoria.InsertarAuditoriaDestrabeMolinete(Cod_Molinete, Usuario, TipoResultado);
                    return true;
                }
        ...
        public void ActualizarTipoVueloMolinete(string Cod_Molinete, string TipoVuelo, string Cod_Usuario, string TipoResultado, string TipoConexion)
        {
            try
            {
                if (ACS_Property.BConRemota)
                {
                    Obj_DAOMolinete.actualizarTipoVueloMolinete(Cod_Molinete, TipoVuelo, Cod_Usuario, TipoResultado, TipoConexion);                    
