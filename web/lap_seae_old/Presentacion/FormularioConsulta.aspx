<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormularioConsulta.aspx.cs" Inherits="FormularioConsulta" Culture="Auto" UICulture="Auto" %>
    ...
    <table style="width:70%" align="center">
                                    ...
                                    <table cellpadding="0" cellspacing="0" style="width:100%">
                                        <tr>
                                            <td style="width:30%">
                                                Compañia:</td>
                                            <td>
                                                <asp:DropDownList ID="cboCompanias" runat="server" Width="150px" 
                                            CssClass="combo">
                                                </asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table cellpadding="0" cellspacing="0" style="width:100%">
                                        <tr>
                                            <td style="width:30%">
                                                <asp:Label ID="lblFormato" runat="server" Text="Nombre Pasajero:"></asp:Label></td>
                                            <td>
                                    ...
                                    <table cellpadding="0" cellspacing="0" style="width:100%">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                Format="dd/MM/yyyy" PopupButtonID="imbCalendar" 
                                                TargetControlID="txtFechaVuelo" PopupPosition="TopRight">
                                                            </cc1:CalendarExtender>
                                                        </td>
                                                        <td>
                                                            <asp:ImageButton ID="imbCalendar" runat="server" Height="22px" 
                                                ImageUrl="~/Imagenes/Calendar.bmp" Width="22px" onclientclick="return false" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnConsultar" runat="server" Text="Consultar" 
                                        CssClass="Boton" onclick="btnConsultar_Click" />
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
        ...
        <tr>
            ...
            <div style="overflow:auto; width: 100%; height: 420px; 
                                ...
                                padding:0px; margin: 0px;  z-index: 10000000; float: none;">   
            
            <iframe id="IframeReporte" src="#" width="100%"  height="100%" align="center" frameborder="0" name="I1" style="z-index: 50000000;"></iframe>
