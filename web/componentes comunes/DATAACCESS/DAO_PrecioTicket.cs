...
namespace LAP.TUUA.DAO
{
    public class DAO_PrecioTicket : DAO_BaseDatos
    {
        ...
        public bool eliminarCrit(PrecioTicket oPrecioTicket)
        {
            try
            {
                //Hashtable hsDeleteUSP = (Hashtable)htSPConfig["PTSP_DELETE"];
                ...
                DbCommand objCommandWrapper = helper.GetStoredProcCommand("usp_ope_pcs_precioticket_del_crit");

                helper.AddInParameter(objCommandWrapper, "Cod_Precio_Ticket", DbType.String, oPrecioTicket.SCodPrecioTicket);
                helper.AddInParameter(objCommandWrapper, "IdTxCritica", DbType.Int64, oPrecioTicket.IdTxCritica);
        ...
        public bool insertarCrit(PrecioTicket objPrecioTicket)
        {
            try
            {
                //Hashtable hsInsertUSP = (Hashtable)htSPConfig["TC_NEW_PTSP_INSERT"];
                ...
                DbCommand objCommandWrapper = helper.GetStoredProcCommand("usp_ope_pcs_precioticket_upd_crit");

                helper.AddInParameter(objCommandWrapper, "Cod_Precio_Ticket", DbType.String, objPrecioTicket.SCodPrecioTicket);
                helper.AddInParameter(objCommandWrapper, "Cod_Tipo_Ticket", DbType.String, objPrecioTicket.SCodTipoTicket);
                helper.AddInParameter(objCommandWrapper, "Cod_Moneda", DbType.String, objPrecioTicket.SCodMoneda);
                helper.AddInParameter(objCommandWrapper, "Imp_Precio", DbType.Decimal, objPrecioTicket.DImpPrecio);
                helper.AddInParameter(objCommandWrapper, "Log_Usuario_Mod", DbType.String, objPrecioTicket.SLogUsuarioMod);
                helper.AddInParameter(objCommandWrapper, "Tip_Ingreso", DbType.String, objPrecioTicket.STipIngreso);
                helper.AddInParameter(objCommandWrapper, "Tip_Estado", DbType.String, objPrecioTicket.STipEstado);
                if (objPrecioTicket.DtFchProgramacion == DateTime.MinValue)
                {
                ...
                helper.AddInParameter(objCommandWrapper, "IdTxCritica", DbType.String, objPrecioTicket.IdTxCritica);

                isRegistrado = base.mantenerSP(objCommandWrapper);

                if (isRegistrado)//Ejecuto el Store Procedure satisfactoriamente
                {
                    objPrecioTicket.SCodRetorno = (string)helper.GetParameterValue(objCommandWrapper, "Cod_Retorno");
                }
                return isRegistrado;
            }
            catch (Exception)
