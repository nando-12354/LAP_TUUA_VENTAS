...
namespace LAP.TUUA.DAO
{
    public class DAO_ModalidadAtrib : DAO_BaseDatos
    {
        ...
        public int validarSerieTicket(int SerieIni, int SerieFin, string modalidad)
        {
            ...
            Hashtable hsSelectAllUSP = (Hashtable)htSPConfig["VALIDACION_SERIETICKET"];
            string sNombreSP = (string)hsSelectAllUSP["VALIDACION_SERIETICKET"];
            objResult = base.listarDataReaderSP(sNombreSP, SerieIni, SerieFin, modalidad);
