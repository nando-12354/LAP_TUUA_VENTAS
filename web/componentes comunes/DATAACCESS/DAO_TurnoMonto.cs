    ...
    public class DAO_TurnoMonto : DAO_BaseDatos
    {
        ...
        public bool actualizar(TurnoMonto objTurnoMonto)
        {
            ...
            try
            {
                ...
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["Imp_Monto_Inicial"], DbType.Decimal, objTurnoMonto.DImpMontoInicial);
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["Imp_Monto_Final"], DbType.Decimal, objTurnoMonto.DImpMontoFinal);
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["Imp_Monto_Actual"], DbType.Decimal, objTurnoMonto.DImpMontoActual);
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["Tip_Pago"], DbType.String, objTurnoMonto.Tip_Pago);
        ...
        public TurnoMonto poblar(IDataReader dataReader)
        {
            try
            {
                ...
                if (dataReader[(string)htSelectAllUSP["Tip_Pago"]] != DBNull.Value)
                    objTurnoMonto.Tip_Pago = (string)dataReader[(string)htSelectAllUSP["Tip_Pago"]];
