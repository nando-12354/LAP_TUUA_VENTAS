    ...
    public class DAO_CnfgAlarma : DAO_BaseDatos
    {
        ...
        public bool insertar(CnfgAlarma objCnfgAlarma)
        {
            try
            {
                ...
                helper.AddInParameter(objCommandWrapper, "Dsc_Asunto", DbType.String, objCnfgAlarma.SDscAsunto);
        ...
        public CnfgAlarma poblar(IDataReader dataReader)
        {
            ...
            if (dataReader["Dsc_Subject"] != DBNull.Value)
                objCnfgAlarma.SDscAsunto = (string)dataReader["Dsc_Subject"];
