...
namespace LAP.TUUA.DAO
{
    public class DAO_ParameGeneral : DAO_BaseDatos
    {
        ...
        public DataTable ObtenerEmpresaPorIdentificadorPadre(string identificador) //FL.
        {
            DataTable result;
            Hashtable hsSelectByIdUSP = (Hashtable)htSPConfig["OBTENER_POR_IDENTIFICADOR_PADRE"];
            string sNombreSP = (string)hsSelectByIdUSP["OBTENER_POR_IDENTIFICADOR_PADRE"];
            result = base.ListarDataTableSP(sNombreSP, identificador);
        ...
        //Kinzi
        public DataTable ObtenerParametroGeneralDefaultValue(string sIdentificador)
        {
            DataTable result;
            //Hashtable hsSelectByIdUSP = (Hashtable)htSPConfig["usp_cns_pcs_parametrogeneraldefaultvalue_sel"];
            //string sNombreSP = (string)hsSelectByIdUSP["usp_cns_pcs_parametrogeneraldefaultvalue_sel"];

            result = base.ListarDataTableSP("usp_cns_pcs_parametrogeneraldefaultvalue_sel", sIdentificador);
            return result;
        }
