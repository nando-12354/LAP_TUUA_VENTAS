...
namespace LAP.TUUA.DAO
{
    public class DAO_Molinete : DAO_BaseDatos
    {
        ...
        public bool actualizarUnMolinete(Molinete objMolinete)
        {
            try
            {
                Hashtable hsUpdateUSP = (Hashtable)htSPConfig["MSP_UPDATEUNMOLINETE"];
                string sNombreSP = (string)hsUpdateUSP["MSP_UPDATEUNMOLINETE"];

                DbCommand objCommandWrapper = helper.GetStoredProcCommand(sNombreSP);
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["Cod_Molinete"], DbType.String, objMolinete.SCodMolinete);
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["hostMolinete"], DbType.String, objMolinete.SDscIp);
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["Dsc_Molinete"], DbType.String, objMolinete.SDscMolinete);
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["Tip_Documento"], DbType.String, objMolinete.STipDocumento);
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["Tip_Vuelo"], DbType.String, objMolinete.STipVuelo);
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["Tip_Acceso"], DbType.String, objMolinete.STipAcceso);
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["Tip_Molinete"], DbType.String, objMolinete.STipMolinete);
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["Tip_Estado"], DbType.String, objMolinete.STipEstado);
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["Log_Usuario_Mod"], DbType.String, objMolinete.SLogUsuarioMod);
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["Est_Master"], DbType.String, objMolinete.SEstMaster);
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["Dsc_DBName"], DbType.String, objMolinete.SDscDBName);
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["Dsc_DBUser"], DbType.String, objMolinete.SDscDBUser);
                helper.AddInParameter(objCommandWrapper, (string)hsUpdateUSP["Dsc_DBPassword"], DbType.String, objMolinete.SDscDBPassword);
        ...
        {
            DataTable result;
            Hashtable hsSelectByIdUSP = (Hashtable)htSPConfig["MSP_LISTARALLMOLINETES"];
            string sNombreSP = (string)hsSelectByIdUSP["MSP_LISTARALLMOLINETES"];
        ...
        {
            DataTable result;
            Hashtable hsSelectByIdUSP = (Hashtable)htSPConfig["MSP_OBTENERMOLINETE"];
            string sNombreSP = (string)hsSelectByIdUSP["MSP_OBTENERMOLINETE"];
            result = base.ListarDataTableSP(sNombreSP, strCodMolinete);
            return result;
        }
