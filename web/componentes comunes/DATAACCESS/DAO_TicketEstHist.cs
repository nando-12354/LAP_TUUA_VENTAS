...
namespace LAP.TUUA.DAO
{
    public class DAO_TicketEstHist : DAO_BaseDatos
    {
        ...
        public DataTable listarTicketEstHist_Arch(string sNumTicket)
        {
            try
            {
                DataTable result;
        ...
        public DataTable obtenerTicketBoardingUsados(string sFechaDesde, string sFechaHasta, string sHoraDesde, string sHoraHasta, string sCodCompania, string sTipoVuelo, string sNumVuelo, string sTipoPasajero, string sTipoDocumento, string sTipoTrasbordo, string sFechaVuelo, string sEstado)
        {
            try
            {
                ...
                result = base.ListarDataTableSP(sNombreSP, sFechaDesde, sFechaHasta, sHoraDesde, sHoraHasta, sCodCompania, sTipoVuelo, sNumVuelo, sTipoPasajero, sTipoDocumento, sTipoTrasbordo, sFechaVuelo, sEstado);
                return result;
            }
            catch (Exception ex)
            {
