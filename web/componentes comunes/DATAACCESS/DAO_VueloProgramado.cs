...
namespace LAP.TUUA.DAO
{
    public class DAO_VueloProgramado : DAO_BaseDatos
    {
        ...
        public DataTable DetallexLineaVuelo(string sFechaDesde, string sFechaHasta, string sCodCompania, string sColumnaSort, int iStartRows, int iMaxRows, string sPaginacion, string sFlgTotalRows)
        {
            DataTable result;
            try
            {
                ...
                result = base.ListarDataTableSP(sNombreSP, sFechaDesde, sFechaHasta, sCodCompania, sColumnaSort, iStartRows, iMaxRows, sPaginacion, sFlgTotalRows);
                return result;
            }
            catch (Exception)
            {
        ...
        public VueloProgramado ObtenerVueloxNum(string FchInicio, string NumVuelo)
        {
              ...
              result = base.listarDataReaderSP(sNombreSP, FchInicio, NumVuelo);
