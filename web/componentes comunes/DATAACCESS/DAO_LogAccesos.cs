...
namespace LAP.TUUA.DAO
{
    public class DAOLogAcceso : DAO_BaseDatos
    {
        ...
        public DAOLogAcceso(Hashtable htSPConfig)
            : base(htSPConfig)
        {
            objListaLogAcceso = new List<LogAcceso>();
        }
        ...
        public bool insertar(LogAcceso objLogAcceso)
        {
            try
            {
                Hashtable hsInsertUSP = (Hashtable)htSPConfig["USP_LOGACCESOS_INSERT"];
                string sNombreSP = (string)hsInsertUSP["USP_LOGACCESOS_INSERT"];
