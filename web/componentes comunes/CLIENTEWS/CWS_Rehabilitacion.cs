...
{
    public class CWS_Rehabilitacion : CWS_Conexion
    {
        private WSRehabilitacion.WSRehabilitacion objWSRehabilitacion;

        public CWS_Rehabilitacion()
        {
            objWSRehabilitacion = new WSRehabilitacion.WSRehabilitacion();
        }


        public override DataTable ConsultarRepresXRehabilitacionYCia(string strCia)
        {
            return objWSRehabilitacion.ConsultarRepresXRehabilitacionYCia(strCia);
        }

        public override bool registrarRehabilitacionTicket(TicketEstHist objTicketEstHist, int flag, int sizeOutput)
        {
            WSRehabilitacion.TicketEstHist objWSTicketEstHist = new WSRehabilitacion.TicketEstHist();

            objWSTicketEstHist.SCodNumeroTicket = objTicketEstHist.SCodNumeroTicket;
            objWSTicketEstHist.SDscNumVuelo = objTicketEstHist.SDscNumVuelo;
            objWSTicketEstHist.SLogUsuarioMod = objTicketEstHist.SLogUsuarioMod;
            objWSTicketEstHist.SCausalRehabilitacion = objTicketEstHist.SCausalRehabilitacion;

            bool ret = objWSRehabilitacion.registrarRehabilitacionTicket(ref objWSTicketEstHist, flag, sizeOutput);
            objTicketEstHist.SCodNumeroTicket = objWSTicketEstHist.SCodNumeroTicket;//CORREGIDO
            return ret;
        }

        public override DataTable consultarVuelosTicketPorCiaFecha(string sCompania, string fechaVuelo)
        {
            return objWSRehabilitacion.consultarVuelosTicketPorCiaFecha(sCompania, fechaVuelo);
        }

        public override DataTable consultarTicketsPorVuelo(string sCompania, string fechaVuelo, string dsc_Num_Vuelo)
        {
            return objWSRehabilitacion.consultarTicketsPorVuelo(sCompania, fechaVuelo, dsc_Num_Vuelo);
        }

        public override DataTable consultarVuelosBCBPPorCiaFecha(string sCompania, string fechaVuelo)
        {
            return objWSRehabilitacion.consultarVuelosBCBPPorCiaFecha(sCompania, fechaVuelo);
        }

        public override bool registrarRehabilitacionBCBP(BoardingBcbpEstHist boardingBcbpEstHist, int flag, int sizeOutput)
        {
            WSRehabilitacion.BoardingBcbpEstHist objWSBoardingBcbpEstHist = new WSRehabilitacion.BoardingBcbpEstHist();

            objWSBoardingBcbpEstHist.SListaBcbPs = boardingBcbpEstHist.SListaBcbPs;
            objWSBoardingBcbpEstHist.SLogUsuarioMod = boardingBcbpEstHist.SLogUsuarioMod;
            objWSBoardingBcbpEstHist.SCausalRehabilitacion = boardingBcbpEstHist.SCausalRehabilitacion;

            bool ret = objWSRehabilitacion.registrarRehabilitacionBCBP(ref objWSBoardingBcbpEstHist, flag, sizeOutput);
            boardingBcbpEstHist.SListaBcbPs = objWSBoardingBcbpEstHist.SListaBcbPs;
            return ret;
        }
        ...
        public override bool registrarRehabilitacionBCBPAmpliacion(BoardingBcbpEstHist boardingBcbpEstHist, int flag, int sizeOutput)
        {
            ...
            //CMONTES PARA LA ASOCIAR BCBP
            objWSBoardingBcbpEstHist.SEstadoAsoc = boardingBcbpEstHist.SEstadoAsoc;
            objWSBoardingBcbpEstHist.SCompaniaAsoc = boardingBcbpEstHist.SCompaniaAsoc;
            objWSBoardingBcbpEstHist.SFechaVueloAsoc = boardingBcbpEstHist.SFechaVueloAsoc;
            objWSBoardingBcbpEstHist.SNroVueloAsoc = boardingBcbpEstHist.SNroVueloAsoc;
            objWSBoardingBcbpEstHist.SNroAsientoAsoc = boardingBcbpEstHist.SNroAsientoAsoc;
            objWSBoardingBcbpEstHist.SPasajeroAsoc = boardingBcbpEstHist.SPasajeroAsoc;


            bool ret = objWSRehabilitacion.registrarRehabilitacionBCBPAmpliacion(ref objWSBoardingBcbpEstHist, flag, sizeOutput);
            boardingBcbpEstHist.SListaBcbPs = objWSBoardingBcbpEstHist.SListaBcbPs;
            return ret;
        }
        ...
        {
            return objWSRehabilitacion.listarCompania_xCodigoEspecial(codigoEspecial);
        }
        ...
        {
            return objWSRehabilitacion.obteneterBoardingsByRangoFechas(sCompania, sFchDesde, sFchHasta, sHoraDesde, sHoraHasta);
        }

        #region Metodo No Implementados
