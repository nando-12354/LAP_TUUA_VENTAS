...
namespace LAP.TUUA.CLIENTEWS
{
    public class CWS_Administracion : CWS_Conexion
    {
        ...
        public override Compania obtenerCompañiaxcodigo(string sCodigoCompania)
        {
            ...
            objWSCompania = objWSAdministracion.obtenerCompañiaxcodigo(sCodigoCompania);
        ...
        {
            wsAdministracion.Compania objWSCompania = null;
            objWSCompania = objWSAdministracion.obtenerCompañiaxnombre(sNombreCompania);
            if (objWSCompania != null)
            {
                return new Compania(objWSCompania.SCodCompania, objWSCompania.STipCompania,
                    objWSCompania.SDscCompania, objWSCompania.DtFchCreacion, objWSCompania.STipEstado,
        ...
        {
            wsAdministracion.ModVentaComp[] lista = objWSAdministracion.ListarModVentaCompxCompañia(sCodCompania);
