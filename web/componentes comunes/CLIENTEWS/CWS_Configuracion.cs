...
namespace LAP.TUUA.CLIENTEWS
{
    public class CWS_Configuracion : CWS_Conexion
    {
        ...
        {
            return objWSConfiguracion.ListarAllParametrosGenerales(strParametro);
        ...
        public override bool GrabarParametroGeneral(string as_ValoresFormulario, string as_ValoresGrilla, string as_ParametroVenta)
        {
            return objWSConfiguracion.GrabarParametroGeneral(as_ValoresFormulario, as_ValoresGrilla, as_ParametroVenta);
        }


        public override ParameGeneral obtenerParametroGeneral(string sCodParam)
        {
            WSConfiguracion.ParameGeneral objWSParameGeneral = null;
            objWSParameGeneral = objWSConfiguracion.obtenerParametroGeneral(sCodParam);
            if (objWSParameGeneral != null)
            {
                return new ParameGeneral(objWSParameGeneral.SIdentificador, objWSParameGeneral.SDescripcion,
                    objWSParameGeneral.STipoParametro, objWSParameGeneral.STipoParametroDet, objWSParameGeneral.STipoValor,
                    objWSParameGeneral.SValor, objWSParameGeneral.SCampoLista, objWSParameGeneral.SIdentificadorPadre,
                    objWSParameGeneral.SLog_Usuario_Mod, objWSParameGeneral.SLog_Fecha_Mod, objWSParameGeneral.SLog_Hora_Mod);
            }
            else return null;
        ...
        public override bool actualizarHoras(ListaDeCampo objListaCampo)
        {
            ...
            return objWSConfiguracion.actualizarHoras(objWSListaDeCampo);
        }
        ...
        {
            return objWSConfiguracion.EliminarListaDeCampo(strNomCampo, strCodCampo);
        }
        ...
        {
            //Casting
            ws.Sincronizacion objWSSincronizacion = new ws.Sincronizacion();
            objWSSincronizacion.SCodigoSincronizacion = objListaSincronizacion.SCodigoSincronizacion;
            objWSSincronizacion.STipoEstado = objListaSincronizacion.STipoEstado;


            return objWSConfiguracion.actualizarestado(objWSSincronizacion);
        }
