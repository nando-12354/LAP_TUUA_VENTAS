...
using wsAlarma = LAP.TUUA.CLIENTEWS.WSAlarmas;
using System.Data;

namespace LAP.TUUA.CLIENTEWS
{
    public class CWS_Alarma : CWS_Conexion
    {
        protected wsAlarma.WSAlarmas objWSAlarma;

        public CWS_Alarma()
        {
            objWSAlarma = new wsAlarma.WSAlarmas();
        }
        ...
        {
            wsAlarma.CnfgAlarma objWSCnfgAlarma = new wsAlarma.CnfgAlarma();

            objWSCnfgAlarma.SCodAlarma = objCnfgAlarma.SCodAlarma;
            objWSCnfgAlarma.SCodModulo = objCnfgAlarma.SCodModulo;
            objWSCnfgAlarma.SDscFinMensaje = objCnfgAlarma.SDscFinMensaje;
            objWSCnfgAlarma.SDscDestinatarios = objCnfgAlarma.SDscDestinatarios;
            objWSCnfgAlarma.SLogUsuarioMod = objCnfgAlarma.SLogUsuarioMod;
            objWSCnfgAlarma.SLogFechaMod = objCnfgAlarma.SLogFechaMod;
            objWSCnfgAlarma.SLogHoraMod = objCnfgAlarma.SLogHoraMod;

            return objWSAlarma.insertarCnfgAlarma(objWSCnfgAlarma);
        }
        ...
        public override bool actualizarCnfgAlarma(CnfgAlarma objCnfgAlarma)
        {
            ...
            return objWSAlarma.actualizarCnfgAlarma(objWSCnfgAlarma);
        }


        public override bool eliminarCnfgAlarma(string sCodAlarma, string sCodModulo)
        {
            return objWSAlarma.eliminarCnfgAlarma(sCodAlarma, sCodModulo);
        }


        public override DataTable ListarAllCnfgAlarma()
        {
            return objWSAlarma.ListarAllCnfgAlarma();
        }


        public override CnfgAlarma obtenerCnfgAlarma(string sCodAlarma, string sCodModulo)
        {
            wsAlarma.CnfgAlarma objWSCnfgAlarma = null;
            objWSCnfgAlarma = objWSAlarma.obtenerCnfgAlarma(sCodAlarma, sCodModulo);
            if (objWSCnfgAlarma != null)
            {
                return new CnfgAlarma(objWSCnfgAlarma.SCodAlarma, objWSCnfgAlarma.SCodModulo,
                    objWSCnfgAlarma.SDscFinMensaje, objWSCnfgAlarma.SDscDestinatarios, objWSCnfgAlarma.SLogUsuarioMod,
                    objWSCnfgAlarma.SLogFechaMod, objWSCnfgAlarma.SLogHoraMod);
            }
            else return null;
        }
        ...
        {
            wsAlarma.AlarmaGenerada objWSAlarmaGenerada = new wsAlarma.AlarmaGenerada();

            objWSAlarmaGenerada.SCodAlarma = objAlarmaGenerada.SCodAlarma;
            objWSAlarmaGenerada.SCodModulo = objAlarmaGenerada.SCodModulo;
            objWSAlarmaGenerada.STipImportancia = objAlarmaGenerada.STipImportancia;
            objWSAlarmaGenerada.SDscSubject = objAlarmaGenerada.SDscSubject;
            objWSAlarmaGenerada.SDscBody = objAlarmaGenerada.SDscBody;
            objWSAlarmaGenerada.SLogUsuarioMod = objAlarmaGenerada.SLogUsuarioMod;

            return objWSAlarma.insertarAlarmaGenerada(objWSAlarmaGenerada);
        }
        ...
        public override bool actualizarAlarmaGenerada(AlarmaGenerada objAlarmaGenerada)
        {
            ...
            objWSAlarmaGenerada.ICodAlarmaGenerada = objAlarmaGenerada.ICodAlarmaGenerada;
            objWSAlarmaGenerada.STipEstado = objAlarmaGenerada.STipEstado;
            objWSAlarmaGenerada.SFlgEstadoMail = objAlarmaGenerada.SFlgEstadoMail;
            objWSAlarmaGenerada.SDscAtencion = objAlarmaGenerada.SDscAtencion;
            objWSAlarmaGenerada.SLogUsuarioMod = objAlarmaGenerada.SLogUsuarioMod;

            return objWSAlarma.actualizarAlarmaGenerada(objWSAlarmaGenerada);
        }


        public override DataTable ListarAllAlarmaGenerada()
        {
            return objWSAlarma.ListarAllAlarmaGenerada();
        }
        ...
        {
            wsAlarma.AlarmaGenerada objWSAlarmaGenerada = null;
            objWSAlarmaGenerada = objWSAlarma.obtenerAlarmaGenerada(sCodAlarmaGenerada);
            if (objWSAlarmaGenerada != null)
            {
                return new AlarmaGenerada(objWSAlarmaGenerada.ICodAlarmaGenerada, objWSAlarmaGenerada.SCodAlarma,
                    objWSAlarmaGenerada.SCodModulo, objWSAlarmaGenerada.DtFchGeneracion, objWSAlarmaGenerada.DtFchActualizacion,
                    objWSAlarmaGenerada.STipEstado, objWSAlarmaGenerada.STipImportancia, objWSAlarmaGenerada.SFlgEstadoMail,
                    objWSAlarmaGenerada.SDscSubject, objWSAlarmaGenerada.SDscBody, objWSAlarmaGenerada.SLogUsuarioMod);
            }
            else return null;
        }
        ...
        {
            return objWSAlarma.ListarAlarmaGeneradaEnviadas();
        }
        ...
        {
            return objWSAlarma.ConsultaAlarmaGenerada(sFchDesde, sFchHasta, sHoraDesde, sHoraHasta, sModulo, sTipoAlarma, sEstado);
        }
        ...
        {
            return objWSAlarma.ObtenerAlarmaxCodModulo(sCodModulo);
        }
        ...
        public override DataTable DetalleBoardingEstHist(string strNumSecuencial)
        {
            throw new NotImplementedException();
        }
