...
{
    public class NAT_Rehabilitacion : NAT_Conexion
    {
        protected string Dsc_PathSPConfig;
        private DAO_Representante objDAORepresentante;
        private DAO_TicketEstHist objDAOTicketEstHist;
        private DAO_Ticket objDAOTicket;
        private DAO_BoardingBcbp objDAOBoardingBcbp;
        private DAO_BoardingBcbpEstHist objDAOBoardingBcbpEstHist;
        private DAO_Compania objDAOCompania;

        public NAT_Rehabilitacion()
        {
            ...
            objDAOBoardingBcbp = new DAO_BoardingBcbp(Dsc_PathSPConfig);
            objDAOBoardingBcbpEstHist = new DAO_BoardingBcbpEstHist(Dsc_PathSPConfig);
        ...
        public override DataTable ConsultarRepresXRehabilitacionYCia(string strCia)
        {
            try
            {
                return objDAORepresentante.consultarRepresXRehabilitacionYCia(strCia);
            }
            catch (Exception ex)
            {
        ...
        public override bool registrarRehabilitacionTicket(TicketEstHist objTicketEstHist, int flag, int sizeOutput)
        {
            try
            {
                objDAOTicketEstHist.Cod_Modulo = Cod_Modulo;
                objDAOTicketEstHist.Cod_Sub_Modulo = Cod_Sub_Modulo;
                objDAOTicketEstHist.Cod_Usuario = Cod_Usuario;
        ...
        public override DataTable consultarVuelosTicketPorCiaFecha(string sCompania, string fechaVuelo)
        {
            try
            {
                return objDAOTicket.consultarVuelosTicketPorCiaFecha(sCompania, fechaVuelo);
            }
            catch (Exception ex)
            {
                ErrorHandler.ObtenerCodigoExcepcion(ex.GetType().Name);
        ...
        public override DataTable consultarTicketsPorVuelo(string sCompania, string fechaVuelo, string dsc_Num_Vuelo)
        {
            try
            {
                return objDAOTicket.consultarTicketsPorVuelo(sCompania, fechaVuelo, dsc_Num_Vuelo);
            }
            catch (Exception ex)
            {
                ErrorHandler.ObtenerCodigoExcepcion(ex.GetType().Name);
        ...
        public override DataTable consultarVuelosBCBPPorCiaFecha(string sCompania, string fechaVuelo)
        {
            try
            {
                return objDAOBoardingBcbp.consultarVuelosBCBPPorCiaFecha(sCompania, fechaVuelo);
            }
            catch (Exception ex)
            {
                ErrorHandler.ObtenerCodigoExcepcion(ex.GetType().Name);
        ...
        public override bool registrarRehabilitacionBCBP(BoardingBcbpEstHist boardingBcbpEstHist, int flag, int sizeOutput)
        {
            try
            {
                objDAOBoardingBcbpEstHist.Cod_Modulo = Cod_Modulo;
                objDAOBoardingBcbpEstHist.Cod_Sub_Modulo = Cod_Sub_Modulo;
                objDAOBoardingBcbpEstHist.Cod_Usuario = Cod_Usuario;
        ...
        public override DataTable obteneterBoardingsByRangoFechas(string sCompania, string sFchDesde, string sFchHasta, string sHoraDesde, string sHoraHasta)
        {
            try
            {
                return objDAOBoardingBcbp.obteneterBoardingsByRangoFechas(sCompania, sFchDesde, sFchHasta, sHoraDesde, sHoraHasta);
            }
            catch (Exception ex)
            {
                ErrorHandler.ObtenerCodigoExcepcion(ex.GetType().Name);
        ...
        public override DataTable ConsultaDetalleTicket2_Reh(string as_numeroticket, string as_ticketdesde, string as_tickerhasta, string as_flg_total)
        {
            throw new NotImplementedException();
        }
