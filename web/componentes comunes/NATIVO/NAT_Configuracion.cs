   ...
   public class NAT_Configuracion: NAT_Conexion
    {
       ...
       public override System.Data.DataTable ListarAllParametroGenerales(string strParametro)
        {
            try
            {
                return objDAOParameGenerales.ListarAllParametroGeneral(strParametro);
            }
            catch (Exception ex)
            {
       ...
       public override bool GrabarParametroGeneral(string as_ValoresFormulario, string as_ValoresGrilla, string as_ParametroVenta)
       {
           try
           {
               objDAOParameGenerales.Cod_Modulo = Cod_Modulo;
               objDAOParameGenerales.Cod_Sub_Modulo = Cod_Sub_Modulo;
               objDAOParameGenerales.Cod_Usuario = Cod_Usuario;
               return objDAOParameGenerales.grabarParametroGeneral(as_ValoresFormulario, as_ValoresGrilla, as_ParametroVenta);
           }
           catch (Exception ex)
           {
               ErrorHandler.ObtenerCodigoExcepcion(ex.GetType().Name);
       ...
       public override ParameGeneral obtenerParametroGeneral(string sCodParam)
       {
           try
           {
               return objDAOParameGenerales.obtener(sCodParam);
           }
           catch (Exception ex)
           {
               ErrorHandler.ObtenerCodigoExcepcion(ex.GetType().Name);
       ...
       public override bool actualizarestado(Sincronizacion objListaSincronizacion)
       {
           try
           {
               objDAOSincronizacion.Cod_Modulo = Cod_Modulo;
               objDAOSincronizacion.Cod_Sub_Modulo = Cod_Sub_Modulo;
               objDAOSincronizacion.Cod_Usuario = Cod_Usuario;              
               return objDAOSincronizacion.actualizarestado(objListaSincronizacion);
           }
           catch (Exception ex)
           {
               ErrorHandler.ObtenerCodigoExcepcion(ex.GetType().Name);
       ...
       public override bool RegistrarListaDeCampo(ListaDeCampo objListaCampo, int intTipo)
       {
           try
           {
               objDAOListaDeCampos.Cod_Modulo = Cod_Modulo;
               objDAOListaDeCampos.Cod_Sub_Modulo = Cod_Sub_Modulo;
               objDAOListaDeCampos.Cod_Usuario = Cod_Usuario;
       ...
       public override bool actualizarHoras(ListaDeCampo objListaCampo)
       {
           try
           {
               ...
               objDAOListaDeCampos.Cod_Sub_Modulo = Cod_Sub_Modulo;
               objDAOListaDeCampos.Cod_Usuario = Cod_Usuario;
               return objDAOListaDeCampos.actualizarHoras(objListaCampo);
           }
           catch (Exception ex)
           {
               ErrorHandler.ObtenerCodigoExcepcion(ex.GetType().Name);
       ...
       public override bool EliminarListaDeCampo(string strNomCampo,string strCodCampo)
       {
           try
           {
               ...
               objDAOListaDeCampos.Cod_Sub_Modulo = Cod_Sub_Modulo;
               objDAOListaDeCampos.Cod_Usuario = Cod_Usuario;
               return objDAOListaDeCampos.eliminar(strNomCampo, strCodCampo);
           }
           catch (Exception ex)
           {
               ErrorHandler.ObtenerCodigoExcepcion(ex.GetType().Name);
