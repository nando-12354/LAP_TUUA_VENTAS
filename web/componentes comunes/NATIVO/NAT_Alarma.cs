...
{
    public class NAT_Alarma : NAT_Conexion
    {
        protected string Dsc_PathSPConfig;
        DAO_CnfgAlarma objDAOCnfgAlarma;
        DAO_AlarmaGenerada objDAOAlarmaGenerada;
        DAO_Alarma objDAOAlarma;

        public NAT_Alarma()
        {
            Dsc_PathSPConfig = (string)Property.htProperty["PATHRECURSOS"];
            objDAOCnfgAlarma = new DAO_CnfgAlarma(Dsc_PathSPConfig,Cod_Usuario,Cod_Modulo,Cod_Sub_Modulo);
            objDAOAlarmaGenerada = new DAO_AlarmaGenerada(Dsc_PathSPConfig, Cod_Usuario, Cod_Modulo, Cod_Sub_Modulo);
            objDAOAlarma = new DAO_Alarma(Dsc_PathSPConfig, Cod_Usuario, Cod_Modulo, Cod_Sub_Modulo);
        }
        ...
        public override bool insertarCnfgAlarma(CnfgAlarma objCnfgAlarma)
        {
            try
            {
                objDAOCnfgAlarma.Cod_Modulo = Cod_Modulo;
                objDAOCnfgAlarma.Cod_Sub_Modulo = Cod_Sub_Modulo;
                objDAOCnfgAlarma.Cod_Usuario = Cod_Usuario;
