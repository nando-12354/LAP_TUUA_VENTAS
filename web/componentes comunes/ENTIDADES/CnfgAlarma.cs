...
namespace LAP.TUUA.ENTIDADES
{
    public class CnfgAlarma
    {
        ...
        public CnfgAlarma(string sCodAlarma, string sCodModulo, string sDscFinMensaje, string sDscAsunto, string sDscDestinatarios, string sLogUsuarioMod, string sLogFechaMod, string sLogHoraMod)
        {
            this.sCodAlarma = sCodAlarma;
            this.sDscFinMensaje = sDscFinMensaje;
            this.sDscAsunto = sDscAsunto;
            this.sCodModulo = sCodModulo;
            this.sDscDestinatarios = sDscDestinatarios;
            this.sLogUsuarioMod = sLogUsuarioMod;
            this.sLogFechaMod = sLogFechaMod;
        ...
        public string SDscAsunto
        {
            get { return sDscAsunto; }
            set { sDscAsunto = value; }
        }
