...
namespace LAP.TUUA.UTIL
{
    ...
    public class Excel
    {
        ...
        public class Worksheet
        {
            ...
            private string _fechaEstadistico;
            ...
            public string FechaEstadistico
            {
                get { return _fechaEstadistico; }
                set { _fechaEstadistico = value; }
            }
            ...
            public StringBuilder obtenerDatosXML()
            {
                ...
                //validacion de fechaEstadistico
                if (FechaEstadistico != null)
                {
                    worksheetXML.Append("<Row ss:AutoFitHeight=\"0\">\n");
                    worksheetXML.Append("<Cell><Data ss:Type=\"String\">" + FechaEstadistico + "</Data></Cell></Row>\n");
                }
