...
namespace LAP.TUUA.CONTROL
{
    public class BO_Turno
    {
        ...
        public bool IniciarTurno(List<TurnoMonto> listaMonedas, string strUsuario, string strEquipo)
        {
            ...
            {
                dtConsulta = objCnxConsulta.ConsultaTurnoxFiltro(null, null, strUsuario, null, null, null,null);
                string strCodTurno = "";
            ...
            {
                dtConsulta = objCnxConsulta.ConsultaTurnoxFiltro(null, null, null, strEquipo, null, null, null);
                string strCodTurno = "";
                for (int i = 0; i < dtConsulta.Rows.Count; i++)
                {
            ...
            if (objCnxTurno.CrearTurno("TURNO", strUsuario, strEquipo))
            {
        ...
        {
            return objCnxTurno.ListarMonedasxTipoTicket();
        }
            ...
            ref decimal decRecaudadoFin)
        {
            ...
            if (dtCuadre.Rows[0].ItemArray.GetValue(13).ToString().Trim() != string.Empty)
            {
                decEfectivoFinal = decimal.Parse(dtCuadre.Rows[0].ItemArray.GetValue(13).ToString());
            }
            else
            {
                decEfectivoFinal = decimal.Zero;
            }
            ...
            if (dtCuadre.Rows[0].ItemArray.GetValue(42).ToString().Trim() != string.Empty)
            {
                decRecaudadoFin = decimal.Parse(dtCuadre.Rows[0].ItemArray.GetValue(42).ToString());
            }
            else
            {
                decRecaudadoFin = decimal.Zero;
            }

        }


        public void ListarCuadreTurno2(string strMoneda, string strTurno, ref decimal decEfectivoIni, ref int intTicketInt, ref int intTicketNac, ref decimal decTicketInt, ref decimal decTicketNac, ref int intIngCaja, ref decimal decIngCaja, ref int intVentaMoneda, ref decimal decVentaMoneda, ref int intEgreCaja, ref decimal decEgreCaja, ref int intCompraMoneda, ref decimal decCompraMoneda, ref decimal decEfectivoFinal, ref int intAnulaInt, ref int intAnulaNac, ref int intInfanteInt, ref int intInfanteNac, ref int intCreditoInt, ref int intCreditoNac, ref decimal decCreditoInt, ref decimal decCreditoNac,
            ref int intTicketEfeInt, ref decimal decTicketEfeInt, ref int intTicketTraInt, ref decimal decTicketTraInt, ref int intTicketDebInt, ref decimal decTicketDebInt, ref int intTicketCreInt, ref decimal decTicketCreInt, ref int intTicketCheInt, ref decimal decTicketCheInt,
            ref int intTicketEfeNac, ref decimal decTicketEfeNac, ref int intTicketTraNac, ref decimal decTicketTraNac, ref int intTicketDebNac, ref decimal decTicketDebNac, ref int intTicketCreNac, ref decimal decTicketCreNac, ref int intTicketCheNac, ref decimal decTicketCheNac,
            ref decimal decRecaudadoFin)
        {
            ...
            intTicketCreInt = Int32.Parse(dtCuadre.Rows[0].ItemArray.GetValue(43).ToString());

            if (dtCuadre.Rows[0].ItemArray.GetValue(44).ToString().Trim() != string.Empty)
            {
                decTicketCreInt = decimal.Parse(dtCuadre.Rows[0].ItemArray.GetValue(44).ToString());
            }
            else
            {
                decTicketCreInt = decimal.Zero;
            }
            ...
            intTicketCreNac = Int32.Parse(dtCuadre.Rows[0].ItemArray.GetValue(45).ToString());

            if (dtCuadre.Rows[0].ItemArray.GetValue(46).ToString().Trim() != string.Empty)
            {
                decTicketCreNac = decimal.Parse(dtCuadre.Rows[0].ItemArray.GetValue(46).ToString());
            }
            else
            {
                decTicketCreNac = decimal.Zero;
            }
