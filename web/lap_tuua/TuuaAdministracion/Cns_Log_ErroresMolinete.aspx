<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cns_Log_ErroresMolinete.aspx.cs"
    Inherits="Rpt_TicketBoardingRehabilitados" ResponseEncoding="utf-8" %>
                                        ...
                                        <ContentTemplate>
                                            <cc2:PagingGridView ID="grvErrorNoFuncional" runat="server" AutoGenerateColumns="False"
                                                ...
                                                CellPadding="3" Width="100%" AllowPaging="True" CssClass="grilla" AllowSorting="True"
                                                  GroupingDepth="0" OnPageIndexChanging="grvErrorNoFuncional_PageIndexChanging"
