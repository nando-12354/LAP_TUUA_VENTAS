<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reh_TicketsPorSalida.aspx.cs" Inherits="Reh_Tickets" ResponseEncoding="utf-8" %>
...
<body>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function btnAgregar_clientClick() {
            if (ioPort == 0) {
                document.getElementById('spnRehabilitar').innerHTML = "";
                if (document.forms[0].txtNroTicket.value.length < 8) {
                    document.getElementById('lblErrNroTicket').innerHTML = "*";
                        ...
                        <ContentTemplate>
                            <table align="center" border="0" cellpadding="0" cellspacing="0" class="TamanoTabla"
                                ...
                                <tr class="formularioTitulo">
                                    <td align="left">
                                        <asp:Button ID="btnRehabilitar" Text="Rehabilitar" runat="server" CssClass="Boton" OnClientClick="Javascript:return btn_Rehabilitar_clientClick();"
    ...
    <script type="text/javascript">
        function Atras() {
            window.location.href = "./Reh_TicketsPorSalida.aspx";
        }
