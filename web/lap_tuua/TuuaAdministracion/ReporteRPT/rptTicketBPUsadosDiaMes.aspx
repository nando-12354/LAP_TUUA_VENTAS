<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTicketBPUsadosDiaMes.aspx.cs"
    Inherits="ReporteRPT_rptTicketBPUsadosDiaMes" %>
...
<body>
    ...
    <CR:CrystalReportViewer ID="crvrptTicketBPUsadosDiaMes" runat="server" AutoDataBind="true"
         Height="50px" SeparatePages="False" Width="100%" HasCrystalLogo="False"
