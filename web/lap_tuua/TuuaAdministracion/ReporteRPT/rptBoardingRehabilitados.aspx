<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptBoardingRehabilitados.aspx.cs" Inherits="ReporteRPT_rptTicketBoardingRehabilitado" %>
...
<head id="Head1" runat="server">
    <title>Reporte Boarding Rehabilitados</title>
...
<body>
    <form id="form1" runat="server">
     <div>
        ...
        <asp:Label ID="lblMensajeErrorData" runat="server" CssClass="mensaje"></asp:Label>
        <CR:CrystalReportViewer ID="crptBoardingRehabilitado" runat="server" AutoDataBind="true" 
