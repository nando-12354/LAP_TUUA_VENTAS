...
public partial class Modulo_Consultas_ConsultaTransaccionCritica : System.Web.UI.Page
{
    protected Hashtable htLabels;
    public string orden = "";
    protected bool Flg_Error;
    protected BO_Error objError;
    BO_Consultas objConsulta = new BO_Consultas(Define.CNX_05);
    ...
    private int GetRowCount()
    {
        ...
        dt_consulta = objConsulta.obtenerconsultaAuditoriasPaginCrit(sTipoOperacion, sTabla, sCodModulo, sCodSubModulo, sCodUsuario, sFchDesde, sFchHasta, sHraDesde, sHraHasta, null, 0, 0, "1");
    ...
    private DataTable GetDataPage(int pageIndex, int pageSize, string sortExpression)
    {
        ...
        dt_consulta = objConsulta.obtenerconsultaAuditoriasPaginCrit(sTipoOperacion, sTabla, sCodModulo, sCodSubModulo, sCodUsuario, sFchDesde, sFchHasta, sHraDesde, sHraHasta, sortExpression, pageIndex, valorMaxGrilla, "0");
