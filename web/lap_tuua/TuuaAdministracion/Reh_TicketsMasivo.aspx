<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reh_TicketsMasivo.aspx.cs"
    Inherits="Reh_TicketsMasivo" ResponseEncoding="utf-8" %>
...
<head id="Head1" runat="server">
    <title>LAP - Rehabilitacion de Tickets Masivo</title>
...
<body onload="CargaPropiedades()">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 100%">
                                                            ...
                                                            <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
                                                                <tr class="formularioTitulo" id="trVuelo" runat="server">
                                                                    <td height="30px">
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                                        <asp:ImageButton ID="btnRefresh" ImageAlign="AbsMiddle" runat="server" OnClick="btnRefresh_Click"
                                                                            ImageUrl="~/Imagenes/Refresh.bmp" />
                                                                    </td>
                                                                    <td>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <div id="divGrid" style="height: 520px; overflow: auto;">
                                                                            <asp:GridView ID="gwvRehabilitarPorTicket" runat="server" RowStyle-VerticalAlign="Middle"
                                                                                ...
                                                                                <Columns>
                                                                                    <asp:BoundField DataField="Numero" HeaderText="Nro." SortExpression="Numero" ItemStyle-Width="8%" />
    ...
    <script type="text/javascript">
    function Atras() {
      window.location.href = "./Reh_TicketsMasivo.aspx";
    }
