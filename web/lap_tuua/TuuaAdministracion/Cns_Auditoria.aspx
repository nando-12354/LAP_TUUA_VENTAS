<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cns_Auditoria.aspx.cs" Inherits="Modulo_Consultas_ConsultaAuditoria" %>

<%@ Register Assembly="PaginGridView" Namespace="Pagin.Web.Control" TagPrefix="cc2" %>
<%@ Register Src="UserControl/PiePagina.ascx" TagName="PiePagina" TagPrefix="uc2" %>
<%@ Register Src="UserControl/CabeceraMenu.ascx" TagName="CabeceraMenu" TagPrefix="uc1" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="UserControl/DetalleAuditoria.ascx" TagName="DetalleAuditoria" TagPrefix="uc3" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>LAP - Consulta - Auditoria</title>
    <!--meta http-equiv="X-UA-Compatible" content="IE=8" /-->
    <meta name="keypage" content="cns_auditoria" />
    ...
    <!--
        ...
        function imgPrint_onclick() {
            ...
            var ventimp = window.open("ReporteCNS/rptAuditoria.aspx" + "?sTipoOperacion=" + sTipoOperacion
...
<body>
    ...
    <uc3:DetalleAuditoria ID="DetalleAuditoria1" runat="server" />
    </form>
