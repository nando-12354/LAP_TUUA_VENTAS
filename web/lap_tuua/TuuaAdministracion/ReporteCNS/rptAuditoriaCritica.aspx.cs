...
public partial class ReporteCNS_rptAuditoriaCritica : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (dt_parametro.Rows.Count > 0)
        {
            ...
            else
            {
                ...
                dt_consulta = objConsulta.obtenerconsultaAuditoriasPaginCrit(sTipoOperacion, sTabla, sCodModulo, sCodSubModulo, sCodUsuario, sFchDesde, sFchHasta, sHraDesde, sHraHasta, null, 0, 0, "0");
