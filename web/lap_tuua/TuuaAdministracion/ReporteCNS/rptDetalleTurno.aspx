<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDetalleTurno.aspx.cs" Inherits="ReporteCNS_rptDetalleTurno" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="crptvDetTurno" runat="server" 
            AutoDataBind="true" 
