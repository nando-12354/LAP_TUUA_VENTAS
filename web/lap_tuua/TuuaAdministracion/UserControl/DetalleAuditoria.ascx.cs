...
public partial class UserControl_DetalleAuditoria : System.Web.UI.UserControl
{
    ...
    public void CargarDetalle(string NomUsuario, string NomRoles, string NomTabla,string CodContador)
    {
        ...
        try
        {
            DataTable dt_consulta = objWBConsultas.obtenerdetalleAuditoria(NomTabla, CodContador);
