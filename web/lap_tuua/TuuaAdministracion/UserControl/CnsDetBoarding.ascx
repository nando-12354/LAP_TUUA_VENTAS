<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CnsDetBoarding.ascx.cs"
    Inherits="UserControl_CnsDetBoarding" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="TamanoTabla" align="center">
                <tr>
                    <!-- TITLE - ZONE -->
                    <td align="center" class="Espacio1FilaTabla" rowspan="13">
                        &nbsp;&nbsp;
                    </td>
                ...
                <td style="width: 2%;" rowspan="6">
                    ...
                    <td>
                        <asp:Label ID="lblDetNumeroBCBP" runat="server" CssClass="TextoFiltro" 
                            Font-Bold="True" Font-Names="Arial" Font-Size="Small" ForeColor="#008FD5"></asp:Label>
                    </td>
                    <td>                        
                    ...
                    <td>
                        <asp:Label ID="lblDetDestino" runat="server" CssClass="TextoFiltro" 
                            Font-Bold="True" Font-Names="Arial" Font-Size="Small" ForeColor="#008FD5"></asp:Label>
                    </td>
                     <td>                        
                     ...
                     <td>
                        <asp:Label ID="lblDetETicket" runat="server" CssClass="TextoFiltro" 
                            Font-Bold="True" Font-Names="Arial" Font-Size="Small" ForeColor="#008FD5"></asp:Label>
                    </td>
                </tr>
                <tr>
                <!-- Octava Fila - ZONE -->
                    ...
                    <td>                        
                     ...
                     <td>
                        <asp:Label ID="lblDetBloqueadoUso" runat="server" CssClass="TextoFiltro" 
                            Font-Bold="True" Font-Names="Arial" Font-Size="Small" ForeColor="#008FD5"></asp:Label>
                    </td>
                    <td>                        
                    ...
                    <td>
                        <asp:Label ID="lblDetIncluyeTUUA" runat="server" CssClass="TextoFiltro" 
                            Font-Bold="True" Font-Names="Arial" Font-Size="Small" ForeColor="#008FD5"></asp:Label>
                    </td>
                </tr>
                ...
                <td>                        
                    ...
                    <td>
                        <asp:Label ID="lblDetInvocacionWBS" runat="server" CssClass="TextoFiltro" 
                            Font-Bold="True" Font-Names="Arial" Font-Size="Small" ForeColor="#008FD5"></asp:Label>
                    </td>
                </tr>
                <tr>
                    ...
                    <div style="width: 96%;">
                        <div style="height: 250px; width: 100%; overflow: auto; text-align: left">
                            ...
                            <asp:GridView ID="grvBoardingEstHist" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" AllowPaging="False"
                                CellPadding="3" CssClass="grilla" GridLines="Vertical" OnPageIndexChanging="grvBoardingEstHist_PageIndexChanging"
                            ...
                            <asp:GridView ID="grvBoardingAsociados" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Fecha Asociación">
                                        <ItemTemplate>
                                            <asp:Label ID="lblFechaAsociacion" runat="server" Text='<%# LAP.TUUA.UTIL.Fecha.convertSQLToFecha(Convert.ToString(Eval("Log_Fecha_Mod")),Convert.ToString(Eval("Log_Hora_Mod"))) %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
