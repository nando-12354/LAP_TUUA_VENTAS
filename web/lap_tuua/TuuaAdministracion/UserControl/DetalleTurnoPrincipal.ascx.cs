...
public partial class UserControl_DetalleTurnoPrincipal : System.Web.UI.UserControl
{
    protected Hashtable htLabels;
    protected bool Flg_Error;
    protected BO_Error objError;
    public string p_sTurno;
    ...
    public void IniciarDetalleTurno(string p_sCodigoTurno)
    {
        p_sTurno = p_sCodigoTurno;
        ...
        try
        {
            dt_listaturno = objListaAllTurno.ConsultaAllTurno(p_sTurno);
        }
        catch (Exception ex)
        {
            Response.Redirect("PaginaError.aspx");
        ...
        this.lblDetEquipo.Text = dt_listaturno.Rows[0].ItemArray.GetValue(5).ToString();
    ...
    public void CargarGrillas()
    {
        try
        {
            ...
            dt_cantidadmonedaturno = objCantidadMonedasTurno.CantidadMonedasTurno(p_sTurno);
            ...
            if (dt_cantidadmonedaturno.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dt_cantidadmonedaturno.Rows.Count; i++)
                {
                    ...
                    if (i == 0)
                    {
                        ...
                        dtDetalleMoneda1 = objDetalleMonedaTurno.DetalleMonedasTurno(p_sTurno, TipMoneda, null);
                        ViewState["Moneda1"] = dtDetalleMoneda1;
                    }
                    if (i == 1)
                    {
                        lblMoneda2.Text = dt_cantidadmonedaturno.Rows[i].ItemArray.GetValue(1).ToString();
                        dtDetalleMoneda2 = objDetalleMonedaTurno.DetalleMonedasTurno(p_sTurno, TipMoneda, null);
                    ...
                    if (i == 2)
                    {
                        ...
                        dtDetalleMoneda3 = objDetalleMonedaTurno.DetalleMonedasTurno(p_sTurno, TipMoneda, null);
                    ...
                    if (i == 3)
                    {
                        ...
                        dtDetalleMoneda4 = objDetalleMonedaTurno.DetalleMonedasTurno(p_sTurno, TipMoneda, null);
                    ...
                    if (i == 4)
                    {
                        ...
                        dtDetalleMoneda5 = objDetalleMonedaTurno.DetalleMonedasTurno(p_sTurno, TipMoneda, null);
                    ...
                    if (i == 5)
                    {
                        ...
                        dtDetalleMoneda6 = objDetalleMonedaTurno.DetalleMonedasTurno(p_sTurno, TipMoneda, null);
                    ...
                    if (i == 6)
                    {
                        ...
                        dtDetalleMoneda7 = objDetalleMonedaTurno.DetalleMonedasTurno(p_sTurno, TipMoneda, null);
                    ...
                    if (i == 7)
                    {
                        ...
                        dtDetalleMoneda8 = objDetalleMonedaTurno.DetalleMonedasTurno(p_sTurno, TipMoneda, null);
                    ...
                    if (i == 8)
                    {
                        ...
                        dtDetalleMoneda9 = objDetalleMonedaTurno.DetalleMonedasTurno(p_sTurno, TipMoneda, null);
                    ...
                    if (i == 9)
                    {
                        ...
                        dtDetalleMoneda10 = objDetalleMonedaTurno.DetalleMonedasTurno(p_sTurno, TipMoneda, null);
                    ...
                    if (i == 10)
                    {
                        ...
                        dtDetalleMoneda11 = objDetalleMonedaTurno.DetalleMonedasTurno(p_sTurno, TipMoneda, null);
                    ...
                    if (i == 11)
                    {
                        ...
                        dtDetalleMoneda12 = objDetalleMonedaTurno.DetalleMonedasTurno(p_sTurno, TipMoneda, null);
                    ...
                    if (i == 12)
                    {
                        ...
                        dtDetalleMoneda13 = objDetalleMonedaTurno.DetalleMonedasTurno(p_sTurno, TipMoneda, null);
                    ...
                    if (i == 13)
                    {
                        ...
                        dtDetalleMoneda14 = objDetalleMonedaTurno.DetalleMonedasTurno(p_sTurno, TipMoneda, null);
                    ...
                    if (i == 14)
                    {
                        ...
                        dtDetalleMoneda15 = objDetalleMonedaTurno.DetalleMonedasTurno(p_sTurno, TipMoneda, null);
                ...
                grvMoneda7.DataSource = dtDetalleMoneda6;
                grvMoneda7.DataBind();

                grvMoneda8.DataSource = dtDetalleMoneda6;
                grvMoneda8.DataBind();

                grvMoneda9.DataSource = dtDetalleMoneda6;
                grvMoneda9.DataBind();

                grvMoneda10.DataSource = dtDetalleMoneda6;
                grvMoneda10.DataBind();

                grvMoneda11.DataSource = dtDetalleMoneda6;
                grvMoneda11.DataBind();

                grvMoneda12.DataSource = dtDetalleMoneda6;
                grvMoneda12.DataBind();

                grvMoneda13.DataSource = dtDetalleMoneda6;
                grvMoneda13.DataBind();

                grvMoneda14.DataSource = dtDetalleMoneda6;
                grvMoneda14.DataBind();

                grvMoneda15.DataSource = dtDetalleMoneda6;
    ...
    protected void grvMoneda2_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            int rowIndex = Int32.Parse(e.CommandArgument.ToString());
            DataTable dtMoneda2 = (DataTable)ViewState["Moneda2"];
            string codTurno = dtMoneda2.Rows[rowIndex]["Turno"].ToString();
            string codMoneda = dtMoneda2.Rows[rowIndex]["Moneda"].ToString();
            string codDetalle = dtMoneda2.Rows[rowIndex]["idDetalle"].ToString();
            CnsDetTurno.Inicio(codTurno, codMoneda, codDetalle);
        }
    }
    protected void grvMoneda3_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            int rowIndex = Int32.Parse(e.CommandArgument.ToString());
            DataTable dtMoneda3 = (DataTable)ViewState["Moneda3"];
            string codTurno = dtMoneda3.Rows[rowIndex]["Turno"].ToString();
            string codMoneda = dtMoneda3.Rows[rowIndex]["Moneda"].ToString();
            string codDetalle = dtMoneda3.Rows[rowIndex]["idDetalle"].ToString();
            CnsDetTurno.Inicio(codTurno, codMoneda, codDetalle);
        }
    }
    protected void grvMoneda4_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            int rowIndex = Int32.Parse(e.CommandArgument.ToString());
            DataTable dtMoneda4 = (DataTable)ViewState["Moneda4"];
            string codTurno = dtMoneda4.Rows[rowIndex]["Turno"].ToString();
            string codMoneda = dtMoneda4.Rows[rowIndex]["Moneda"].ToString();
            string codDetalle = dtMoneda4.Rows[rowIndex]["idDetalle"].ToString();
            CnsDetTurno.Inicio(codTurno, codMoneda, codDetalle);
        }
    }
    protected void grvMoneda5_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            int rowIndex = Int32.Parse(e.CommandArgument.ToString());
            DataTable dtMoneda5 = (DataTable)ViewState["Moneda5"];
            string codTurno = dtMoneda5.Rows[rowIndex]["Turno"].ToString();
            string codMoneda = dtMoneda5.Rows[rowIndex]["Moneda"].ToString();
            string codDetalle = dtMoneda5.Rows[rowIndex]["idDetalle"].ToString();
            CnsDetTurno.Inicio(codTurno, codMoneda, codDetalle);
        }
    }
    protected void grvMoneda6_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            int rowIndex = Int32.Parse(e.CommandArgument.ToString());
            DataTable dtMoneda6 = (DataTable)ViewState["Moneda6"];
            string codTurno = dtMoneda6.Rows[rowIndex]["Turno"].ToString();
            string codMoneda = dtMoneda6.Rows[rowIndex]["Moneda"].ToString();
            string codDetalle = dtMoneda6.Rows[rowIndex]["idDetalle"].ToString();
            CnsDetTurno.Inicio(codTurno, codMoneda, codDetalle);
        }
    }
