<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OkMessageBoxHuge.ascx.cs"
    Inherits="UserControl_OkMessageBoxHuge" %>
...
<asp:Panel ID="pnlPopup" runat="server" CssClass="modalPopup" Style="display: none;"
    DefaultButton="btnOk"  Height="200px" Width="500px">
