<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_LiquidacionVenta.aspx.cs"
    Inherits="Rpt_LiquidacionVenta" %>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <CR:CrystalReportViewer ID="crptvLiquidacionVenta" runat="server" AutoDataBind="true"
                                                ...
                                                PrintMode="ActiveX" HasToggleGroupTreeButton="False"  ShowAllPageIds="True" />
