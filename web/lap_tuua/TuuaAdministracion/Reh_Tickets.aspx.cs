...
public partial class Reh_Tickets : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                lblNroTicket.Text = htLabels["rehabilitacionticket.lblNroTicket"].ToString();
                ...
                if (activarVuelo == 1)
                {
                    ...
                    lblNumVuelo.Text = htLabels["rehabilitacionticket.lblNumVuelo"].ToString();
                }
                else
                {
                ...
                if (activarConsRepre == 1)
                {
                    ...
                    lblConsRepresentante.Text = htLabels["rehabilitacionticket.lblConsRepresentante"].ToString();
                }
                else
                {
    ...
    protected void btnAgregar_Click(object sender, EventArgs e)
    {
        ...
        txtNroTicket.Text = "";
        txtNumVuelo.Text = "";
        //---No entra por validacion previa de Javascript
        ...
        if (ViewState["tabla"] != null)
        {
            ...
            for (int i = (pageIndex * pageSize), j = 0; j < limite; i++, j++)
            {
                ...
                dtTicketRehabilitados.Rows[i]["Motivo"] = cboMotivo.SelectedItem.Value;
        ...
        //icano 10-06-10 : inicialmente estaba declarado dentro de una condicional if, necesito esta variable asi q declara fuera del bucle
        String numeroVuelo = "";
        String compania = "";
        //fin
        ...
        //icano 10-06-10 : obtengo la descripcion del numero de vuelo y compania
        ...
        {
            #region Guardando el HT_DscVuelo
            Hashtable htDscVuelo;
            if (ViewState["htDscVuelo"] == null)
            {
                htDscVuelo = new Hashtable();
                ViewState["htDscVuelo"] = htDscVuelo;
            }
            else
            {
                htDscVuelo = (Hashtable)ViewState["htDscVuelo"];
            }
            htDscVuelo.Remove(dtTicketDetalle.Rows[0]["Cod_Numero_Ticket"]);//porseaca si existiera//preferible aqui que en el Eliminar.
            htDscVuelo.Add(dtTicketDetalle.Rows[0]["Cod_Numero_Ticket"], numVuelo.Trim());
            //ViewState["htDscVuelo"] = htDscVuelo;
            #endregion
        ...
        //icano 10-06-10 : agregando nuevas columnas para el reporte en excel
        ...
        for (int i = (pageIndex * pageSize), j = 0; j < dtTicketRehabilitados.Rows.Count - (pageIndex * pageSize); i++, j++)
        {
            ...
            if (i < dtTicketRehabilitados.Rows.Count - 1)
            {
                ...
                cboMotivo.Items.FindByValue(dtTicketRehabilitados.Rows[i]["Motivo"].ToString()).Selected = true;
                CheckBox chkSeleccionar = (CheckBox)gwvRehabilitarPorTicket.Rows[j].FindControl("chkSeleccionar");
        ...
        //No funciona para la pistola, el Enter Key (13).
        //txtNroTicket.Focus();
    }
    ...
    protected void btnRehabilitar_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            for (int i = 0; i < dtTicketRehabilitados.Rows.Count; i++)
            {
                ...
                if (checkedRehabilitar)
                {
                    ...
                    if (htDscVuelo != null && htDscVuelo[dtTicketRehabilitados.Rows[i]["Cod_Numero_Ticket"]] != null)
                    {
                        dsc_Num_Vuelos.Append((String)htDscVuelo[dtTicketRehabilitados.Rows[i]["Cod_Numero_Ticket"]] + "|");
                    }
                    else
                    {
                        dsc_Num_Vuelos.Append("|");
                    }

                    String motivo = dtTicketRehabilitados.Rows[i]["Motivo"].ToString();
            ...
            ticketEstHist.SDscNumVuelo = dsc_Num_Vuelos.ToString();
            ticketEstHist.SCausalRehabilitacion = causal_Rehabilitaciones.ToString();
            ...
            bool ret = objBORehabilitacion.registrarRehabilitacionTicket(ticketEstHist, 0, 4000);
            if (!ret)
            {
                System.Threading.Thread.Sleep(500);
        ...
        //icano : para probar, No colocar esto en produccion!!!!
        //DataTable dt = new DataTable();
        //dt = (DataTable)ViewState["tabla"];
        //GridView1.DataSource = dt;
        //GridView1.DataBind();
        //fin   
        //ExportarDataTable((DataTable)ViewState["tabla"]); //sale error por el control ajax updatepanel
    }
    #endregion
