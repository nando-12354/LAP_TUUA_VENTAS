...
<%
        ...
        foreach (DataRow dr in dt_consulta.Rows)
        {
            ...
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["TipoTicket"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            ...
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["DiasVencidos"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
