...
<%
        ...
        foreach (DataRow dr in dt_consulta.Rows)
        {
            ...
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Fch_Uso"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            ...
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Fch_Rehabilitacion"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            ...
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Num_Proceso_Rehab"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["TipoVuelo"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
