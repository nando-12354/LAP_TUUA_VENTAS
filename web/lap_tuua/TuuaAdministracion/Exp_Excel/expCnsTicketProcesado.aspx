...
<%
    BO_Consultas objBOConsulta = new BO_Consultas();
        ...
        foreach (DataRow dr in dt_consulta.Rows)
        {
            ...
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Ape_Usuario"].ToString() + " " + dt_consulta.Rows[iCant]["Nom_Usuario"].ToString() + " (" + dt_consulta.Rows[iCant]["Cod_Usuario"].ToString() + ")", CarlosAg.ExcelXmlWriter.DataType.String));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Dsc_Estacion"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String));
            rowD.Cells.Add(new WorksheetCell(Fecha.convertSQLToFecha(dt_consulta.Rows[iCant]["Fch_Inicio"].ToString(), dt_consulta.Rows[iCant]["Hor_Inicio"].ToString()), CarlosAg.ExcelXmlWriter.DataType.String));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Ticket_Proc"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String));
