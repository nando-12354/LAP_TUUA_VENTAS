...
<%
    BO_Consultas objBOConsultas = new BO_Consultas();
        ...
        foreach (DataRow dr in dt_consulta.Rows)
        {
            ...
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Codigo"].ToString(),CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            ...
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Dsc_Documento"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Nom_Modalidad"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            ...
            rowD.Cells.Add(new WorksheetCell(Fecha.convertSQLToFecha(dt_consulta.Rows[iCant]["Log_Fecha_Mod"].ToString(), dt_consulta.Rows[iCant]["Log_Hora_Mod"].ToString()), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["NroAsiento"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Dsc_TipoVuelo"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Dsc_TipoPasajero"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Dsc_Trasbordo"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Dsc_EstadoActual"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Num_Secuencial"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
