...
<%
        ...
        foreach (DataRow dr in dt_consulta.Rows)
        {
            ...
            rowD.Cells.Add(new WorksheetCell(Fecha.convertSQLToFecha(dt_consulta.Rows[iCant]["Fecha_Venta"].ToString(),null), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            ...
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Can_Venta"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Dsc_Repte"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
        ...
        foreach (DataRow dr in dt_resumen.Rows)
        {
            ...
            rowD.Cells.Add(new WorksheetCell(dt_resumen.Rows[iCant]["Cantidad"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, "resumenNum"));
            rowD.Cells.Add(new WorksheetCell(dt_resumen.Rows[iCant]["Monto"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, "resumenNum"));
