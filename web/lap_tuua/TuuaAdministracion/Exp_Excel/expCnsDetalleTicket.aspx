...
<%
        ...
        if ((sTipoReporte == "1") || (sTipoReporte == "2"))
        {
            ...
            foreach (DataRow dr in dt_consulta.Rows)
            {
                ...
                else
                {
                    ...
                    rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["FechaModificacion"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
                    ...
                    rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Fch_Vencimiento"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
                    rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Cod_Turno"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
                    ...
                    rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Cod_Moneda"].ToString() + " (" + dt_consulta.Rows[iCant]["Imp_Precio"].ToString() + ")", CarlosAg.ExcelXmlWriter.DataType.String, estilo));
                    rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Num_Rehabilitaciones"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
        ...
        else
        {
            ...
            foreach (DataRow dr in dt_consulta.Rows)
            {
                ...
                rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Dsc_Tipo_Ingreso"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
                rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Usuario"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
                rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["FechaModificacion"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
                rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Dsc_Campo"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
                rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Flg_Tipo_Bcbp"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
