...
<%
        ...
        foreach (DataRow dr in dt_consulta.Rows)
        {
            ...
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Fecha_Uso"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            ...
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["BP"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Ticket"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Total"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
        ...
        foreach (DataRow dr in dt_resumen.Rows)
        {
            ...
            rowD.Cells.Add(new WorksheetCell(dt_resumen.Rows[iCant]["TotBoarding"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            
            rowD = sheetResumen.Table.Rows.Add();
            rowD.Cells.Add(new WorksheetCell("Ticket", CarlosAg.ExcelXmlWriter.DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_resumen.Rows[iCant]["TotTicket"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String, estilo));
