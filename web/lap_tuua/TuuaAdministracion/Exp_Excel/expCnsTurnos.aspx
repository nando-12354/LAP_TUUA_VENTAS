...
<%
        ...
        foreach (DataRow dr in dt_consulta.Rows)
        {
            ...
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Cod_Turno"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Dsc_Usuario"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Dsc_Estacion"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Fch_Inicio"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Fch_Fin"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["SOL_ImporteIni"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["DOL_ImporteIni"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["SOL_ImporteFin"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["DOL_ImporteFin"].ToString(), CarlosAg.ExcelXmlWriter.DataType.String));
