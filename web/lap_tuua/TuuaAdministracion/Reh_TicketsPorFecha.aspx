<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reh_TicketsPorFecha.aspx.cs"
    Inherits="Reh_TicketsPorFecha" ResponseEncoding="utf-8" %>
...
<head id="Head1" runat="server">
    <title>LAP - Rehabilitacion de Tickets por Fecha</title>
...
<body>
                                                        ...
                                                        <td style="width: 100%">
                                                            ...
                                                            <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="17%">
                                                                        <asp:TextBox ID="txtDesde" runat="server" CssClass="textbox" Width="150px" onfocus="this.blur();"
                                                                        ...
                                                                        <cc1:CalendarExtender ID="txtDesde_CalendarExtender" runat="server" Enabled="True"
                                                                            TargetControlID="txtDesde" PopupButtonID="imgbtnCalendar1" Format="dd/MM/yyyy">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtHasta" runat="server" CssClass="textbox" Width="150px" onfocus="this.blur();"
                                                                            onkeypress="JavaScript: window.event.keyCode = 0;" BackColor="#E4E2DC"></asp:TextBox>
    ...
    <script type="text/javascript">
    function Atras() {
      window.location.href = "./Reh_TicketsPorFecha.aspx";
    }
