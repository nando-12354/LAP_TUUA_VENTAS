<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reh_BCBPMasivo.aspx.cs" Inherits="Reh_BCBPMasivo" %>
...
<head id="Head1" runat="server">
    <title>LAP - Rehabilitacion de BCBP Masivo</title>
...
<body onload="CargaPropiedades()">
    ...
    <script language="javascript" type="text/javascript">
        function SetCheckBoxHeaderGrilla(control) {
            ...
            var observacion = "";
            if (numColumnas == 0)
                observacion = control.parentNode.previousSibling.previousSibling.innerHTML; //ojo
            else
                observacion = control.parentNode.previousSibling.previousSibling.previousSibling.previousSibling.innerHTML; 
                                                        ...
                                                        <td style="width: 100%">
                                                            ...
                                                            <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="17%">
                                                                        ...
                                                                        <tr>
                                                                        <td>
                                                                            <asp:DropDownList ID="cboCompanias" runat="server" OnSelectedIndexChanged="cboCompanias_SelectedIndexChanged"
                                                                    ...
                                                                    <td colspan="3">
                                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="" id="lnkRepresentante"
                                                                            runat="server" onserverclick="lnkRepresentante_Click"><b>
                                                            ...
                                                            <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div id="divGrid" style="height: 460px; overflow: auto;">
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Descripcion BCBP" ItemStyle-Width="50%">
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <asp:HiddenField ID="hCompania" runat="server" Value='<%# Eval("Cod_Compania") %>' />
                                                                                            <asp:HiddenField ID="hNumSecuencialBCBP" runat="server" Value='<%# Eval("Num_Secuencial_Bcbp") %>' /> 
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Asociar" Visible="False">
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <asp:ImageButton ID="btnAdicionarPistola" runat="server" Enabled="true" Height="18px" 
                                                                                            ...
                                                                                            <asp:ImageButton ID="btnAdicionarManual" runat="server" 
                                                                                                ...
                                                                                                CommandName="btnAdicionarManual" Enabled="true" Height="18px" ImageUrl="~/Imagenes/file.gif" 
                                                                                                OnClientClick="obtenerID(this)" Width="18px" />
                                                                                            <br />
                                                                                            <br />
                                                                                            <asp:ImageButton ID="btnEliminarAsociado" runat="server" Enabled="true" Height="18px" 
                                                                                                ImageUrl="~/Imagenes/Delete.bmp" Width="18px" OnClientClick="return eliminarAsociadoBCBP(this)" />
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            <table ID="tblDatosAsociados" runat="server">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        <asp:Label ID="lblFechaVuelo" runat="server" 
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        <asp:Label ID="lblAsiento" runat="server" 
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Eliminar" ItemStyle-Width="10%">
                                                                                        <ItemTemplate>
                                                                                            <asp:ImageButton ID="btnEliminar" runat="server" CommandArgument="<%# Container.DataItemIndex %>"
                                                                                                CommandName="Eliminar" ImageUrl="~/Imagenes/Delete.bmp" Width="20" Height="18"  OnClientClick="resetearSelecControl()" />
                                                                                        </ItemTemplate>
                                                                                        <ItemStyle Width="10%" />
                                                                                    </asp:TemplateField>
                                                                                </Columns>
    ...
    <script type="text/javascript">
        function Atras() {
            window.location.href = "./Reh_BCBPMasivo.aspx";
        }
    ...
    <asp:UpdateProgress AssociatedUpdatePanelID="UpdatePanel1" DisplayAfter="0" ID="updateProgress1"
        runat="server">
        <ProgressTemplate>
