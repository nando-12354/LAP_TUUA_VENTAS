<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Alr_CrearAlarma.aspx.cs"
    Inherits="Alr_CrearAlarma" %>
                ...
                <tr class="formularioTitulo">
                    ...
                    <td align="right">
                        <asp:Button ID="btnAceptar" runat="server" CssClass="Boton" TabIndex="9" OnClick="btnAceptar_Click"
                            OnClientClick="validarAccion()" />
                        <cc2:confirmbuttonextender id="cbeAceptar" runat="server" confirmtext="" enabled="True"
                                                        ...
                                                        <ContentTemplate>
                                                            <table style="width: 95%;">
                                                                <tr>
                                                                    ...
                                                                    <td colspan="4">
                                                                        <asp:DropDownList ID="ddlModulo" runat="server" AutoPostBack="True" CssClass="combo2"
                                                                            TabIndex="3" Width="50%" OnSelectedIndexChanged="ddlModulo_SelectedIndexChanged">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                    <td>
                                                                    </td>                                                                    
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="4">
                                                                        <asp:TextBox ID="txtFinMensaje" runat="server" CssClass="textbox" 
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="4">
                                                                        <asp:DropDownList ID="ddlTipoAlarma" runat="server" AutoPostBack="True" CssClass="combo2" Width="90%"
                                                                            TabIndex="3" OnSelectedIndexChanged="ddlTipoAlarma_SelectedIndexChanged">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                    <td>
                                                                    </td>                                                                    
                                                                ...
                                                                <tr>
                                                                    <td colspan="5" style="height:25px;">
                                                                        <asp:Label ID="lblDesAlarma" runat="server" CssClass="msgMensaje" Width="471px"></asp:Label>
                                                                    </td>
                                                                    <td></td>
                                                                </tr>
                                                                <tr>
