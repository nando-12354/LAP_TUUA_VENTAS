<%@ page language="C#" autoeventwireup="true" inherits="Modulo_Consultas_ConsultaTicketxFecha, App_Web_nfcc8hqf" responseencoding="utf-8" %>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <cc2:PagingGridView ID="grvPaginacion" runat="server" BackColor="White" BorderColor="#999999"
                                                ...
                                                AllowPaging="True" AllowSorting="True" VirtualItemCount="-1" GroupingDepth="0">
