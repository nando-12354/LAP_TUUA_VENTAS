<%@ page language="C#" autoeventwireup="true" inherits="Rpt_ResumenTurno, App_Web_nfcc8hqf" %>
...
<head id="Head1" runat="server">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function consultar() {
            ...
            document.frames.IframeReporte.location.href = "ReporteRPT/rptResumenDiario.aspx?iTipo=2&turnoDesde=" + turnoDesde + "&turnoHasta=" + turnoHasta;
            return false;
        }
                ...
                <td class="CenterGrid">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <iframe id="IframeReporte" src="#" width="100%" height="100%" align="center" frameborder="0"></iframe>                                        
                        </div>
                        </ContentTemplate>
                        <Triggers>
