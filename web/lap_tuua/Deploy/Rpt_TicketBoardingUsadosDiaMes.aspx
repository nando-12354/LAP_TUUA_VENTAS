<%@ page language="C#" autoeventwireup="true" inherits="Rpt_TicketBoardingUsadosDiaMes, App_Web_7ctknflu" responseencoding="utf-8" %>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        ...
                                        <asp:Label ID="lblFechaEstadistico" runat="server" CssClass="msgMensaje"></asp:Label>
                                            <cc2:PagingGridView ID="grvTicketBPUsadosDiaMes" runat="server" AutoGenerateColumns="False"
                                                ...
                                                AllowSorting="True" VirtualItemCount="-1" OnPageIndexChanging="grvTicketBPUsadosDiaMes_PageIndexChanging"
