<%@ page language="C#" autoeventwireup="true" inherits="Rpt_ResumenDiario, App_Web_tx1el90t" %>
...
<head id="Head1" runat="server">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function consultar() {
            ...
            document.frames.IframeReporte.location.href = "ReporteRPT/rptResumenDiario.aspx?iTipo=" + tipo + "&fechaDesde=" + fechaDesde + "&fechaHasta=" + fechaHasta + "&horaDesde=" + horaDesde + "&horaHasta=" + horaHasta;
            return false;
        }
    </script>
