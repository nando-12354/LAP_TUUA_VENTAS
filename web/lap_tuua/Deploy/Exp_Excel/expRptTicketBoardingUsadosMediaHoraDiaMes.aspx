...
<%
        ...
        foreach (DataRow dr in dt_consulta.Rows)
        {
            ...
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Log_Fecha_Mod"].ToString(), DataType.String, estilo));
            ...
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["HoraInicio"].ToString(), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["HoraFin"].ToString(), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Total_BCBP"].ToString(), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Total_Ticket"].ToString(), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell((Convert.ToInt32(dt_consulta.Rows[iCant]["Total_BCBP"].ToString()) + Convert.ToInt32(dt_consulta.Rows[iCant]["Total_Ticket"].ToString())).ToString(), DataType.String, estilo));
        ...
        foreach (DataRow dr in dt_resumen.Rows)
        {
            ...
            rowD.Cells.Add(new WorksheetCell(dt_resumen.Rows[iCant]["Tipo_Documento"].ToString(), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_resumen.Rows[iCant]["Total"].ToString(), DataType.String, estilo));
        ...
        if (sTDocumento == "T")
        {
            ...
            rowD.Cells.Add(new WorksheetCell("0", DataType.String, estilo));
        }
        else
        {
            if (sTDocumento == "B")
