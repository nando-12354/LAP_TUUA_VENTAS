...
<%
        ...
        if (idTipoDocumento == "T")
        {
            ...
            foreach (DataRow dr in dt_consulta.Rows)
            {
                ...
                else
                {
                    ...
                    rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Fch_Creacion"].ToString(), DataType.String, estilo));
                    ...
                    rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["FHEmision"].ToString(), DataType.String, estilo));
                    rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["FHUso"].ToString(), DataType.String, estilo));
                    rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["FHReh"].ToString(), DataType.String, estilo));
        ...
        else
        {
            ...
            foreach (DataRow dr in dt_consulta.Rows)
            {
                ...
                rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Dsc_Tip_Ingreso"].ToString(), DataType.String, estilo));
                rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Cta_Usuario"].ToString(), DataType.String, estilo));
                rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Fch_Creacion"].ToString(), DataType.String, estilo));
                rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Dsc_Tip_Estado"].ToString(), DataType.String, estilo));
                rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Flg_Tipo_Bcbp"].ToString()=="1"? "Si" : "No", DataType.String, estilo));
