...
<%
        ...
        foreach (DataRow dr in dt_consulta.Rows)
        {
            ...
            rowD.Cells.Add(new WorksheetCell(Fecha.convertSQLToFecha(dt_consulta.Rows[iCant]["FechaVenta"].ToString(),null), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(Fecha.convertSQLToFecha(dt_consulta.Rows[iCant]["FechaRehab"].ToString(),null), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(Fecha.convertSQLToHora(dt_consulta.Rows[iCant]["HoraRehab"].ToString()), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Dsc_Compania"].ToString(), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["NumVuelo"].ToString(), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["DesMotivo"].ToString(), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["DesDocument"].ToString(), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Cod_Numero_Ticket"].ToString(), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Secuencial"].ToString(), DataType.String, estilo));
        ...
        int iCantBoarding = dtBoarding.Length;
            ...
            rowR.Cells.Add(new WorksheetCell("TICKET", DataType.String, estilo));
            rowR.Cells.Add(new WorksheetCell(iCantTicket.ToString(), DataType.String, estilo));

            rowR = sheetResumen.Table.Rows.Add();
            rowR.Cells.Add(new WorksheetCell("BOARDING", DataType.String, estilo));
            rowR.Cells.Add(new WorksheetCell(iCantBoarding.ToString(), DataType.String, estilo));
