...
<%
        ...
        foreach (DataRow dr in dt_consulta.Rows)
        {
            ...
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["Num_Secuencial_Bcbp"].ToString(), DataType.String, estilo));
            ...
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["NroMolinete"].ToString(), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["FechaUso"].ToString(), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["FechaAnulacion"].ToString(), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_consulta.Rows[iCant]["FechaRehabilitacion"].ToString(), DataType.String, estilo));
        ...
        foreach (DataRow dr in dt_resumen.Rows)
        {
            ...
            rowD.Cells.Add(new WorksheetCell(dt_resumen.Rows[iCant]["Fecha_Uso_Interno"].ToString(), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_resumen.Rows[iCant]["Dsc_Compania"].ToString(), DataType.String, estilo));
            rowD.Cells.Add(new WorksheetCell(dt_resumen.Rows[iCant]["Num_Vuelo"].ToString(), DataType.String, estilo));
