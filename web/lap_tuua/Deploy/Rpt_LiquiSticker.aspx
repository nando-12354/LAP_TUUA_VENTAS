<%@ page language="C#" autoeventwireup="true" inherits="Rpt_LiquiSticker, App_Web_tx1el90t" %>
                            ...
                            <td class="CenterGrid">
                                <div id="divData" style="overflow: auto; position: relative;">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <CR:CrystalReportViewer ID="crptvLiquiVenta" runat="server" AutoDataBind="true" DisplayGroupTree="False"
                                                SeparatePages="False" HasCrystalLogo="False" PrintMode="ActiveX"
                                                HasToggleGroupTreeButton="False" HasViewList="False" ShowAllPageIds="True" />
