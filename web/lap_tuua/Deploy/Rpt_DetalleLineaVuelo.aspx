<%@ page language="C#" autoeventwireup="true" inherits="Rpt_DetalleLineaVuelo, App_Web_7ctknflu" responseencoding="utf-8" %>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <cc1:PagingGridView ID="grvDetalleLineaVuelo" runat="server" AllowPaging="True" AllowSorting="True"
                                                ...
                                                VirtualItemCount="-1" Width="100%" OnRowDataBound="grvDetalleLineaVuelo_RowDataBound">
